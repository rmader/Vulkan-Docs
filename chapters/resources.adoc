...
Vulkan supports three primary resource types: _buffers_, _images_, and
_tensors_.
endif::VK_ARM_tensors[]
...
<<resources-effective-buffer-usage, effective usage>> includes the
ename:VK_BUFFER_USAGE_2_DESCRIPTOR_HEAP_BIT_EXT flag, and pname:size is
greater than the maximum of
<<limits-maxResourceHeapSize,pname:maxResourceHeapSize>> and
<<limits-maxSamplerHeapSize,pname:maxSamplerHeapSize>>.
If this happens, ename:VK_ERROR_OUT_OF_DEVICE_MEMORY will be returned.

[NOTE]
====
This is an issue identified with apiext:VK_EXT_descriptor_heap, which we
plan to tighten up for the KHR version.
Applications using apiext:VK_EXT_descriptor_heap may wish to avoid
...
[[resources-effective-buffer-usage]]
pname:usage defines the <<fundamentals-effective-flags, effective usage
flags>> for the buffer.
ifdef::VK_BASE_VERSION_1_4,VK_KHR_maintenance5,VK_KHR_extended_flags[]
If the pname:pNext chain includes a slink:VkBufferUsageFlags2CreateInfo
structure, pname:usage is ignored, and the effective usage flags are defined
by slink:VkBufferUsageFlags2CreateInfo::pname:usage.
endif::VK_BASE_VERSION_1_4,VK_KHR_maintenance5,VK_KHR_extended_flags[]
...
ifdef::VK_KHR_maintenance11[]
  * [[VUID-VkBufferCreateInfo-maintenance11-13353]]
    If the <<features-maintenance11,pname:maintenance11>> feature is enabled
    and pname:sharingMode is ename:VK_SHARING_MODE_CONCURRENT, then
    pname:queueFamilyIndexCount must: be greater than `0`
...
ifdef::VK_BASE_VERSION_1_2,VK_EXT_buffer_device_address,VK_KHR_buffer_device_address[]
...
ifdef::VK_EXT_buffer_device_address[]
    ...
    slink:VkPhysicalDeviceBufferDeviceAddressFeaturesEXT::pname:bufferDeviceAddressCaptureReplay>>
    feature
...
ifdef::VK_BASE_VERSION_1_2,VK_KHR_buffer_device_address[]
    ...
    must: be enabled
endif::VK_BASE_VERSION_1_2,VK_EXT_buffer_device_address,VK_KHR_buffer_device_address[]
ifdef::VK_KHR_video_decode_queue[]
...
ifdef::VK_KHR_video_decode_vp9[]
  * [[VUID-VkBufferCreateInfo-pNext-10783]]
    ...
    structure and for any element of its pname:pProfiles member
    pname:videoCodecOperation is
    ename:VK_VIDEO_CODEC_OPERATION_DECODE_VP9_BIT_KHR, then the
    <<features-videoDecodeVP9,pname:videoDecodeVP9>> feature must: be
    enabled
...
ifdef::VK_KHR_video_encode_av1[]
  * [[VUID-VkBufferCreateInfo-pNext-10249]]
    ...
    structure and for any element of its pname:pProfiles member
    pname:videoCodecOperation is
    ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR, then the
    <<features-videoEncodeAV1,pname:videoEncodeAV1>> feature must: be
    enabled
endif::VK_KHR_video_encode_av1[]
ifdef::VK_VALVE_video_encode_rgb_conversion[]
  * [[VUID-VkBufferCreateInfo-pNext-10919]]
    If the pname:pNext chain includes a
    slink:VkVideoEncodeProfileRgbConversionInfoVALVE structure, then the
    <<features-videoEncodeRgbConversion, pname:videoEncodeRgbConversion>>
    feature must: be enabled
endif::VK_VALVE_video_encode_rgb_conversion[]
ifdef::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
...
endif::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
...
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkBufferCreateInfo-tileMemoryHeap-10762]]
    If the <<features-tileMemoryHeap, pname:tileMemoryHeap>> feature is not
    enabled, pname:usage must: not include
    ename:VK_BUFFER_USAGE_TILE_MEMORY_BIT_QCOM
  * [[VUID-VkBufferCreateInfo-usage-10763]]
    If pname:usage includes ename:VK_BUFFER_USAGE_TILE_MEMORY_BIT_QCOM, then
    pname:flags must: not contain any of the
ifdef::VK_BASE_VERSION_1_2[ename:VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT,]
ifdef::VK_EXT_descriptor_buffer[ename:VK_BUFFER_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT,]
ifdef::VK_KHR_video_maintenance1[ename:VK_BUFFER_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR,]
    ename:VK_BUFFER_CREATE_SPARSE_BINDING_BIT,
    ename:VK_BUFFER_CREATE_SPARSE_RESIDENCY_BIT,
    ename:VK_BUFFER_CREATE_SPARSE_ALIASED_BIT, or
    ename:VK_BUFFER_CREATE_PROTECTED_BIT flags
  * [[VUID-VkBufferCreateInfo-usage-10764]]
    If pname:usage includes ename:VK_BUFFER_USAGE_TILE_MEMORY_BIT_QCOM, then
    only the following pname:usages may be set:
...
ifdef::VK_BASE_VERSION_1_2[** ename:VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT]
  ** and if
     slink:VkPhysicalDeviceTileMemoryHeapPropertiesQCOM::pname:tileBufferTransfers
     is ename:VK_TRUE then additionally
     ename:VK_BUFFER_USAGE_TRANSFER_SRC_BIT or
     ename:VK_BUFFER_USAGE_TRANSFER_DST_BIT
endif::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkBufferCreateInfo-flags-09641]]
    If pname:flags includes ename:VK_BUFFER_CREATE_PROTECTED_BIT, then the
    <<resources-effective-buffer-usage, effective usage flags>> must: not
  ...
  ** ename:VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT
  ** ename:VK_BUFFER_USAGE_STORAGE_BUFFER_BIT
ifdef::VK_EXT_buffer_device_address,VK_KHR_buffer_device_address,VK_COMPUTE_VERSION_1_2[]
  ** ename:VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT
endif::VK_EXT_buffer_device_address,VK_KHR_buffer_device_address,VK_COMPUTE_VERSION_1_2[]
ifdef::VK_KHR_video_decode_queue[]
  ** ename:VK_BUFFER_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR
endif::VK_KHR_video_decode_queue[]
ifdef::VK_KHR_video_encode_queue[]
  ** ename:VK_BUFFER_USAGE_2_VIDEO_ENCODE_DST_BIT_KHR
endif::VK_KHR_video_encode_queue[]
ifdef::VK_EXT_descriptor_heap[]
  ** ename:VK_BUFFER_USAGE_2_DESCRIPTOR_HEAP_BIT_EXT
endif::VK_EXT_descriptor_heap[]
ifdef::VK_EXT_descriptor_heap[]
  * [[VUID-VkBufferCreateInfo-flags-11277]]
    If the
    <<limits-protectedDescriptorHeaps,pname:protectedDescriptorHeaps>>
    property is not supported and the <<resources-effective-buffer-usage,
    effective usage flags>> include the
    ename:VK_BUFFER_USAGE_2_DESCRIPTOR_HEAP_BIT_EXT flag, pname:flags must:
    not include the ename:VK_BUFFER_CREATE_PROTECTED_BIT flag
  * [[VUID-VkBufferCreateInfo-flags-11279]]
    If the <<limits-sparseDescriptorHeaps, pname:sparseDescriptorHeaps>>
    property is not supported and the <<resources-effective-buffer-usage,
    effective usage flags>> include the
    ename:VK_BUFFER_USAGE_2_DESCRIPTOR_HEAP_BIT_EXT flag, pname:flags must:
    not include any of the ename:VK_BUFFER_CREATE_SPARSE_BINDING_BIT,
    ename:VK_BUFFER_CREATE_SPARSE_RESIDENCY_BIT, or
    ename:VK_BUFFER_CREATE_SPARSE_ALIASED_BIT flags
endif::VK_EXT_descriptor_heap[]
****
...
ifdef::VK_BASE_VERSION_1_4,VK_KHR_maintenance5,VK_KHR_extended_flags[]
[open,refpage='VkBufferUsageFlags2CreateInfo',desc='Extended buffer usage flags',type='structs']
--
The sname:VkBufferUsageFlags2CreateInfo structure is defined as:

include::{generated}/api/structs/VkBufferUsageFlags2CreateInfo.adoc[]

ifdef::VK_KHR_maintenance5,VK_KHR_extended_flags[]
include::{generated}/api/structs/VkBufferUsageFlags2CreateInfoKHR.adoc[]
endif::VK_KHR_maintenance5,VK_KHR_extended_flags[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:usage is a bitmask of elink:VkBufferUsageFlagBits2 specifying
    allowed usages of the buffer.
...
If this structure is included in the pname:pNext chain of a query structure
including tlink:VkBufferUsageFlags, the usage flags of the buffer are
returned in pname:flags of this structure, allowing additional usage flags
to be queried.
The flags representable in tlink:VkBufferUsageFlags are still returned in
the query structure in this case.

include::{generated}/validity/structs/VkBufferUsageFlags2CreateInfo.adoc[]
--

[open,refpage='VkBufferUsageFlagBits2',desc='Bitmask controlling how a pipeline is created',type='enums']
--
Bits which can: be set in slink:VkBufferUsageFlags2CreateInfo::pname:usage,
specifying usage behavior of a buffer, are:

include::{generated}/api/enums/VkBufferUsageFlagBits2.adoc[]
...
// are mirrored between VkBufferUsageFlagBits2/VkBufferUsageFlagBits

  * ename:VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT specifies that the buffer can:
    be used as the source of a _transfer command_ (see the definition of
    <<synchronization-pipeline-stages-transfer,
    ename:VK_PIPELINE_STAGE_TRANSFER_BIT>>).
  * ename:VK_BUFFER_USAGE_2_TRANSFER_DST_BIT specifies that the buffer can:
    be used as the destination of a transfer command.
  * ename:VK_BUFFER_USAGE_2_UNIFORM_TEXEL_BUFFER_BIT specifies that the
    buffer can: be used to create a sname:VkBufferView suitable for
    occupying a sname:VkDescriptorSet slot of type
    ename:VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER.
  * ename:VK_BUFFER_USAGE_2_STORAGE_TEXEL_BUFFER_BIT specifies that the
    buffer can: be used to create a sname:VkBufferView suitable for
    occupying a sname:VkDescriptorSet slot of type
    ename:VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER.
  * ename:VK_BUFFER_USAGE_2_UNIFORM_BUFFER_BIT specifies that the buffer
  ...
  * ename:VK_BUFFER_USAGE_2_STORAGE_BUFFER_BIT specifies that the buffer
    can: be used in a sname:VkDescriptorBufferInfo suitable for occupying a
    sname:VkDescriptorSet slot either of type
    ename:VK_DESCRIPTOR_TYPE_STORAGE_BUFFER or
    ename:VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC.
  * ename:VK_BUFFER_USAGE_2_INDEX_BUFFER_BIT specifies that the buffer is
    suitable for passing as the pname:buffer parameter to
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance5[flink:vkCmdBindIndexBuffer2 and]
    flink:vkCmdBindIndexBuffer.
  * ename:VK_BUFFER_USAGE_2_VERTEX_BUFFER_BIT specifies that the buffer is
    suitable for passing as an element of the pname:pBuffers array to
    flink:vkCmdBindVertexBuffers.
  * ename:VK_BUFFER_USAGE_2_INDIRECT_BUFFER_BIT specifies that the buffer is
    suitable for passing as the pname:buffer parameter to
...
ifdef::VK_EXT_device_generated_commands[]
    ...
    pname:preprocessAddress or pname:sequenceCountAddress members of
    sname:VkGeneratedCommandsInfoEXT.
...
ifdef::VK_KHR_device_address_commands[]
    flink:vkCmdBindTransformFeedbackBuffers2EXT or
...
ifdef::VK_KHR_device_address_commands[]
    flink:vkCmdBeginTransformFeedback2EXT,
    flink:vkCmdEndTransformFeedback2EXT,
endif::VK_KHR_device_address_commands[]
...
ifdef::VK_QCOM_tile_memory_heap[]
  * ename:VK_BUFFER_USAGE_2_TILE_MEMORY_BIT_QCOM specifies that the buffer
    can: be bound to sname:VkDeviceMemory allocated from a
    slink:VkMemoryHeap with the ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM
    property.
endif::VK_QCOM_tile_memory_heap[]
...
ifdef::VK_BASE_VERSION_1_2,VK_EXT_buffer_device_address,VK_KHR_buffer_device_address[]
  * ename:VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT specifies that the
...
ifdef::VK_EXT_device_generated_commands[]
  * ename:VK_BUFFER_USAGE_2_PREPROCESS_BUFFER_BIT_EXT specifies that the
    buffer can: be used as a preprocess buffer for
    <<device-generated-commands,Device-Generated Commands>>.
endif::VK_EXT_device_generated_commands[]
ifdef::VK_EXT_opacity_micromap[]
  * ename:VK_BUFFER_USAGE_2_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT specifies
    that the buffer can: be used as a <<micromap-building,read-only
    slink:VkMicromapEXT build input>>, which includes the pname:data and
    pname:triangleArray parameters
  * ename:VK_BUFFER_USAGE_2_MICROMAP_STORAGE_BIT_EXT specifies that the
    buffer can: be used to <<resources-micromaps,create slink:VkMicromapEXT
    objects>>.
endif::VK_EXT_opacity_micromap[]
ifdef::VK_AMDX_dense_geometry_format[]
  * ename:VK_BUFFER_USAGE_2_COMPRESSED_DATA_DGF1_BIT_AMDX specifies that the
    buffer is suitable as storage space for <<dense-geometry-format,Dense
    Geometry Format>> data.
endif::VK_AMDX_dense_geometry_format[]
ifdef::VK_ARM_data_graph[]
  * ename:VK_BUFFER_USAGE_2_DATA_GRAPH_FOREIGN_DESCRIPTOR_BIT_ARM specifies
    that the buffer is suitable to contain resource descriptors when bound
    as a descriptor buffer in command buffers allocated from a command pool
    that can: target foreign <<graphs-processing-engines,data graph
    processing engines>>.
endif::VK_ARM_data_graph[]
ifdef::VK_EXT_memory_decompression[]
  * ename:VK_BUFFER_USAGE_2_MEMORY_DECOMPRESSION_BIT_EXT specifies that the
    buffer can: be used as a destination buffer in <<memory-decompression,
    memory decompression>>.
endif::VK_EXT_memory_decompression[]
ifdef::VK_EXT_descriptor_heap[]
  * ename:VK_BUFFER_USAGE_2_DESCRIPTOR_HEAP_BIT_EXT specifies that the
    buffer can: be used as a <<descriptorheaps,descriptor heap>>.
endif::VK_EXT_descriptor_heap[]
--

[open,refpage='VkBufferUsageFlags2',desc='Bitmask of VkBufferUsageFlagBits2',type='flags']
--
include::{generated}/api/flags/VkBufferUsageFlags2.adoc[]

ifdef::VK_KHR_maintenance5,VK_KHR_extended_flags[]
include::{generated}/api/flags/VkBufferUsageFlags2KHR.adoc[]
endif::VK_KHR_maintenance5,VK_KHR_extended_flags[]

tname:VkBufferUsageFlags2 is a bitmask type for setting a mask of zero or
more elink:VkBufferUsageFlagBits2.
--
endif::VK_BASE_VERSION_1_4,VK_KHR_maintenance5,VK_KHR_extended_flags[]
...
ifdef::VK_EXT_opacity_micromap[]
  * ename:VK_BUFFER_USAGE_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT specifies
    that when building a slink:VkMicromapEXT, the buffer can: be used as a
    <<micromap-building,read-only micromap build input>>, which includes the
    pname:data and pname:triangleArray parameters
  * ename:VK_BUFFER_USAGE_MICROMAP_STORAGE_BIT_EXT specifies that the buffer
    can: be used to <<resources-micromaps,create slink:VkMicromapEXT
    objects>>.
endif::VK_EXT_opacity_micromap[]
ifdef::VK_QCOM_tile_memory_heap[]
  * ename:VK_BUFFER_USAGE_TILE_MEMORY_BIT_QCOM specifies that the buffer
    can: be bound to sname:VkDeviceMemory allocated from a
    slink:VkMemoryHeap with the ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM
    property.
endif::VK_QCOM_tile_memory_heap[]
...
ifdef::VK_EXT_descriptor_heap[]
  * ename:VK_BUFFER_USAGE_DESCRIPTOR_HEAP_BIT_EXT specifies that the buffer
    can: be used as a <<descriptorheaps,descriptor heap>>.
endif::VK_EXT_descriptor_heap[]
--
...
ifdef::VK_BASE_VERSION_1_2,VK_KHR_buffer_device_address[]
[open,refpage='VkBufferOpaqueCaptureAddressCreateInfo',desc='Request a specific address for a buffer',type='structs']
--
...
reduce the likelihood of ename:VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS
errors.
...
--
To request a specific device address for a buffer, add a
sname:VkBufferDeviceAddressCreateInfoEXT structure to the pname:pNext chain
...
Applications should: avoid creating buffers with application-provided
addresses and implementation-provided addresses in the same process, to
reduce the likelihood of ename:VK_ERROR_INVALID_DEVICE_ADDRESS_EXT errors.
...
This usage
ifdef::VK_BASE_VERSION_1_4,VK_KHR_maintenance5,VK_KHR_extended_flags[]
can: be defined by including the slink:VkBufferUsageFlags2CreateInfo
...
****
  ...
  * [[VUID-VkBufferViewCreateInfo-buffer-00932]]
    pname:buffer must: have been created with at least one of the
    ename:VK_BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT or
    ename:VK_BUFFER_USAGE_STORAGE_TEXEL_BUFFER_BIT usage flags set
  ...
  * [[VUID-VkBufferViewCreateInfo-buffer-02750]]
    ...
    pname:offset must: be a multiple of the effective alignment requirement
    of pname:format for ename:VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER as
    defined by
  ...
  * [[VUID-VkBufferViewCreateInfo-buffer-02751]]
    ...
    pname:offset must: be a multiple of the effective alignment requirement
    of pname:format for ename:VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER as
    defined by
    <<limits-minTexelBufferOffsetAlignment,pname:minTexelBufferOffsetAlignment>>
...
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance5,VK_KHR_extended_flags[]
  * [[VUID-VkBufferViewCreateInfo-pNext-08780]]
    If the pname:pNext chain includes a slink:VkBufferUsageFlags2CreateInfo,
    its pname:usage must: not contain any other bit than
    ename:VK_BUFFER_USAGE_2_UNIFORM_TEXEL_BUFFER_BIT or
    ename:VK_BUFFER_USAGE_2_STORAGE_TEXEL_BUFFER_BIT
  * [[VUID-VkBufferViewCreateInfo-pNext-08781]]
    If the pname:pNext chain includes a slink:VkBufferUsageFlags2CreateInfo,
    its pname:usage must: be a subset of the
    slink:VkBufferCreateInfo::pname:usage specified or
    slink:VkBufferUsageFlags2CreateInfo::pname:usage from
    slink:VkBufferCreateInfo::pname:pNext when creating pname:buffer
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance5,VK_KHR_extended_flags[]
...
[open,refpage='vkGetBufferDeviceAddress',desc='Query an address of a buffer',type='protos']
--
...
The 64-bit return value, [eq]#code:bufferBaseAddress#, is an address of the
start of pname:pInfo->buffer.
Addresses in the range [eq]#[code:bufferBaseAddress, code:bufferBaseAddress
{plus} slink:VkBufferCreateInfo::pname:size)# can: be used to access the
...
ifdef::VK_EXT_buffer_device_address[]
    or the <<features-bufferDeviceAddressEXT,
    slink:VkPhysicalDeviceBufferDeviceAddressFeaturesEXT::pname:bufferDeviceAddress>>
    feature
endif::VK_EXT_buffer_device_address[]
    must: be enabled, and at least one of the following conditions must: be
    met
ifndef::VKSC_VERSION_1_0[]
  ** pname:buffer is sparse
endif::VKSC_VERSION_1_0[]
  ** pname:buffer is bound completely and contiguously to a single
     sname:VkDeviceMemory object
ifdef::VK_EXT_buffer_device_address[]
  ** pname:buffer was created with the
     ename:VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT flag and the
...
ifdef::VK_EXT_buffer_device_address[]
    ...
    slink:VkPhysicalDeviceBufferDeviceAddressFeaturesEXT::pname:bufferDeviceAddressMultiDevice>>
endif::VK_EXT_buffer_device_address[]
    feature must: be enabled
****
...
[open,refpage='VkBufferDeviceAddressInfo',desc='Structure specifying the buffer to query an address for',type='structs']
--
...
****
  * [[VUID-VkBufferDeviceAddressInfo-buffer-02601]]
    ...
    ename:VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT usage flag set
****
...
ifdef::VK_BASE_VERSION_1_2,VK_KHR_buffer_device_address[]
[open,refpage='vkGetBufferOpaqueCaptureAddress',desc='Query an opaque capture address of a buffer',type='protos']
--
...
****
  * [[VUID-vkGetBufferOpaqueCaptureAddress-None-03326]]
    The <<features-bufferDeviceAddress, pname:bufferDeviceAddress>> and
    <<features-bufferDeviceAddressCaptureReplay,
    pname:bufferDeviceAddressCaptureReplay>> features must: be enabled
  * [[VUID-vkGetBufferOpaqueCaptureAddress-pInfo-10725]]
    pname:pInfo->buffer must: have been created with the
    ename:VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT flag
...
outlined in the <<images>> chapter.
Images can: be used for various purposes, such as <<renderpass, rendering
attachments>>, <<copies, for copy operations>>, or accessed through shaders
via <<descriptors, resource descriptors>>.
...
include::{generated}/api/structs/VkImageCreateInfo.adoc[]
  ...
  * pname:extent is a slink:VkExtent3D describing the number of
...
[[resources-effective-image-create]]
pname:flags defines the <<fundamentals-effective-flags, effective create
flags>> for the image.
ifdef::VK_KHR_extended_flags[]
If the pname:pNext chain includes a slink:VkImageCreateFlags2CreateInfoKHR
structure, pname:flags is ignored, and the effective create flags are
defined by slink:VkImageCreateFlags2CreateInfoKHR::pname:flags.
endif::VK_KHR_extended_flags[]

[[resources-effective-image-usage]]
pname:usage defines the <<fundamentals-effective-flags, effective usage
flags>> for the image.
ifdef::VK_KHR_extended_flags[]
If the pname:pNext chain includes a slink:VkImageUsageFlags2CreateInfoKHR
structure, pname:usage is ignored, and the effective usage flags are defined
by slink:VkImageUsageFlags2CreateInfoKHR::pname:usage.
endif::VK_KHR_extended_flags[]
...
ifdef::VK_EXT_ycbcr_image_arrays[]
    the <<features-ycbcrImageArrays, pname:ycbcrImageArrays>> feature is
    enabled, or
...
ifdef::VK_QCOM_tile_memory_heap[]
Images created with the ename:VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM usage flag
...
ename:VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM may: not be supported unless
parameters meet all of the constraints:

  * pname:flags is 0 or only includes ename:VK_IMAGE_CREATE_ALIAS_BIT
  * pname:imageType is ename:VK_IMAGE_TYPE_2D
  * pname:mipLevels is 1
  * pname:arrayLayers is 1
  * pname:samples is ename:VK_SAMPLE_COUNT_1_BIT
  * pname:tiling is ename:VK_IMAGE_TILING_OPTIMAL
  * pname:usage includes ename:VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM and any
    valid combination of the following ename:VK_IMAGE_USAGE_SAMPLED_BIT,
...
slink:VkPhysicalDeviceHostImageCopyProperties::pname:identicalMemoryTypeRequirements,
usage of ename:VK_IMAGE_USAGE_HOST_TRANSFER_BIT must: not affect the memory
...
[NOTE]
====
For images created without the ename:VK_IMAGE_CREATE_EXTENDED_USAGE_BIT flag
set, a pname:usage bit is valid if it is supported for the format the image
is created with.
...
ifndef::VK_BASE_VERSION_1_1,VK_KHR_external_memory[]
...
ifdef::VK_KHR_video_queue[]
  ...
  *** slink:VkImageCreateInfo::pname:flags only contains
ifdef::VK_KHR_video_maintenance1[]
      ename:VK_IMAGE_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR and/or
endif::VK_KHR_video_maintenance1[]
      bits also set in
...
ifdef::VK_KHR_maintenance11[]
    ...
    pname:sharingMode is ename:VK_SHARING_MODE_CONCURRENT, then
    pname:queueFamilyIndexCount must: be greater than `1`
ifndef::VK_BASE_VERSION_1_1,VK_KHR_get_physical_device_properties2[]
...
ifdef::VK_EXT_zero_initialize_device_memory[]
  * [[VUID-VkImageCreateInfo-initialLayout-10765]]
    ...
    zeroInitializeDeviceMemory>> feature is not enabled, pname:initialLayout
...
ifdef::VK_EXT_image_2d_view_of_3d[]
  ...
  * [[VUID-VkImageCreateInfo-imageType-10197]]
    If pname:flags contains ename:VK_IMAGE_CREATE_2D_VIEW_COMPATIBLE_BIT_EXT
ifdef::VK_KHR_maintenance9[]
and either the <<features-maintenance9,pname:maintenance9>> feature is not
enabled on the device or
<<limits-image2DViewOf3DSparse,pname:image2DViewOf3DSparse>> is
ename:VK_FALSE
...
ifdef::VK_NV_external_memory+VK_NV_external_memory_capabilities[]
  * [[VUID-VkImageCreateInfo-pNext-00991]]
    ...
    member must: only contain bits that are also in
    slink:VkExternalImageFormatPropertiesNV::pname:externalMemoryFeatures.compatibleHandleTypes,
...
ifndef::VKSC_VERSION_1_0[]
  ...
  * [[VUID-VkImageCreateInfo-flags-02259]]
    ...
    pname:imageType must: be ename:VK_IMAGE_TYPE_2D, and
    pname:imageCreateMaybeLinear (as defined in
    <<resources-image-creation-limits,Image Creation Limits>>) must: be
    ename:VK_FALSE
endif::VKSC_VERSION_1_0[]
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
  ...
  * [[VUID-VkImageCreateInfo-initialLayout-00993]]
    pname:initialLayout must: be ename:VK_IMAGE_LAYOUT_UNDEFINED,
ifdef::VK_EXT_zero_initialize_device_memory[ename:VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT,]
  ...
  * [[VUID-VkImageCreateInfo-initialLayout-12478]]
    If pname:initialLayout is ename:VK_IMAGE_LAYOUT_PREINITIALIZED,
    pname:tiling must: be ename:VK_IMAGE_TILING_LINEAR
ifdef::VK_BASE_VERSION_1_1,VK_KHR_external_memory,VK_NV_external_memory[]
...
endif::VK_BASE_VERSION_1_1,VK_KHR_external_memory,VK_NV_external_memory[]
ifdef::VK_COMPUTE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
ifdef::VK_BASE_VERSION_1_2,VK_KHR_image_format_list[]
  * [[VUID-VkImageCreateInfo-pNext-06722]]
    If a slink:VkImageFormatListCreateInfo structure was included in the
    pname:pNext chain and pname:format is not a <<formats-multiplanar,
    ...
    uncompressed format that is <<formats-size-compatibility,
    size-compatible>> with pname:format
  * [[VUID-VkImageCreateInfo-pNext-10062]]
    If a slink:VkImageFormatListCreateInfo structure was included in the
    pname:pNext chain and pname:format is a <<formats-multiplanar,
    multi-planar format>> and pname:flags contains
  ...
  * [[VUID-VkImageCreateInfo-flags-04738]]
    ...
    must: be `0` or `1`
endif::VK_BASE_VERSION_1_2,VK_KHR_image_format_list[]
ifdef::VK_KHR_video_decode_queue[]
...
ifdef::VK_KHR_video_encode_quantization_map[]
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR,
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR, or
...
ifdef::VK_KHR_video_encode_quantization_map[]
  * [[VUID-VkImageCreateInfo-usage-10251]]
    ...
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR, then the
    <<features-videoEncodeQuantizationMap,
    pname:videoEncodeQuantizationMap>> feature must: be enabled
  * [[VUID-VkImageCreateInfo-usage-10252]]
    If pname:usage includes
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR or
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR, pname:imageType
    must: be ename:VK_IMAGE_TYPE_2D
  * [[VUID-VkImageCreateInfo-usage-10253]]
    If pname:usage includes
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR or
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR, pname:samples
    must: be ename:VK_SAMPLE_COUNT_1_BIT
  * [[VUID-VkImageCreateInfo-usage-10254]]
    If pname:usage includes
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR or
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR, then the
    pname:pNext chain must: include a slink:VkVideoProfileListInfoKHR
    structure with pname:profileCount equal to `1` and pname:pProfiles
    pointing to a slink:VkVideoProfileInfoKHR structure with a
    pname:videoCodecOperation member specifying an encode operation
  * [[VUID-VkImageCreateInfo-usage-10255]]
    If pname:usage includes
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR, then
    slink:VkVideoEncodeCapabilitiesKHR::pname:flags must: include
    ename:VK_VIDEO_ENCODE_CAPABILITY_QUANTIZATION_DELTA_MAP_BIT_KHR, as
    returned by flink:vkGetPhysicalDeviceVideoCapabilitiesKHR for the video
    profile specified in the pname:pProfiles member of the
    slink:VkVideoProfileListInfoKHR structure included in the pname:pNext
    chain
  * [[VUID-VkImageCreateInfo-usage-10256]]
    If pname:usage includes
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR, then
    slink:VkVideoEncodeCapabilitiesKHR::pname:flags must: include
    ename:VK_VIDEO_ENCODE_CAPABILITY_EMPHASIS_MAP_BIT_KHR, as returned by
    flink:vkGetPhysicalDeviceVideoCapabilitiesKHR for the video profile
    specified in the pname:pProfiles member of the
    slink:VkVideoProfileListInfoKHR structure included in the pname:pNext
    chain
  * [[VUID-VkImageCreateInfo-usage-10257]]
    ...
    pname:extent.width must: be less than or equal to
    slink:VkVideoEncodeQuantizationMapCapabilitiesKHR::pname:maxQuantizationMapExtent.width,
    as returned by flink:vkGetPhysicalDeviceVideoCapabilitiesKHR for the
    video profile specified in the pname:pProfiles member of the
    slink:VkVideoProfileListInfoKHR structure included in the pname:pNext
    chain
  * [[VUID-VkImageCreateInfo-usage-10258]]
    ...
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR,
    pname:extent.height must: be less than or equal to
    slink:VkVideoEncodeQuantizationMapCapabilitiesKHR::pname:maxQuantizationMapExtent.height,
    as returned by flink:vkGetPhysicalDeviceVideoCapabilitiesKHR for the
    video profile specified in the pname:pProfiles member of the
    slink:VkVideoProfileListInfoKHR structure included in the pname:pNext
    chain
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-VkImageCreateInfo-pNext-06743]]
    ...
    structure, pname:format is a <<formats-multiplanar, multi-planar
    format>>, and slink:VkImageCompressionControlEXT::pname:flags includes
  ...
  * [[VUID-VkImageCreateInfo-pNext-06744]]
    If the pname:pNext chain includes a slink:VkImageCompressionControlEXT
    structure, pname:format is not a <<formats-multiplanar, multi-planar
    format>>, and slink:VkImageCompressionControlEXT::pname:flags includes
    ename:VK_IMAGE_COMPRESSION_FIXED_RATE_EXPLICIT_EXT, then
    slink:VkImageCompressionControlEXT::pname:compressionControlPlaneCount
    must: be 1
endif::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
ifndef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
ifdef::VK_EXT_descriptor_buffer,VK_EXT_descriptor_heap[]
  * [[VUID-VkImageCreateInfo-flags-08104]]
    If pname:flags includes
    ename:VK_IMAGE_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_EXT, the
ifdef::VK_EXT_descriptor_buffer[]
    <<features-descriptorBufferCaptureReplay,
    pname:descriptorBufferCaptureReplay>>
endif::VK_EXT_descriptor_buffer[]
ifdef::VK_EXT_descriptor_buffer,VK_EXT_descriptor_heap[or]
ifdef::VK_EXT_descriptor_buffer[]
    <<features-descriptorHeapCaptureReplay,
    pname:descriptorHeapCaptureReplay>>
endif::VK_EXT_descriptor_buffer[]
 feature must: be enabled
...
ifdef::VK_EXT_metal_objects[]
  ...
  * [[VUID-VkImageCreateInfo-pNext-06785]]
    If the pname:pNext chain includes a slink:VkImportMetalTextureInfoEXT
    structure and the image does not have a <<formats-multiplanar,
  ...
  * [[VUID-VkImageCreateInfo-pNext-06786]]
    If the pname:pNext chain includes a slink:VkImportMetalTextureInfoEXT
    structure and the image has a <<formats-multiplanar, multi-planar
    format>> with only two planes, then
    slink:VkImportMetalTextureInfoEXT::pname:plane must: not be
    ename:VK_IMAGE_ASPECT_PLANE_2_BIT
endif::VK_EXT_metal_objects[]
ifdef::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
  * [[VUID-VkImageCreateInfo-imageCreateFormatFeatures-09048]]
    ...
    <<resources-image-creation-limits,Image Creation Limits>>) does not
    contain ename:VK_FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT, then
    pname:usage must: not contain ename:VK_IMAGE_USAGE_HOST_TRANSFER_BIT
  * [[VUID-VkImageCreateInfo-usage-10245]]
    If pname:usage includes ename:VK_IMAGE_USAGE_HOST_TRANSFER_BIT, then the
    <<features-hostImageCopy, pname:hostImageCopy>> feature must: be enabled
endif::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkImageCreateInfo-tileMemoryHeap-10766]]
    If the <<features-tileMemoryHeap, pname:tileMemoryHeap>> feature is not
    enabled, pname:usage must: not include
    ename:VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM
endif::VK_QCOM_tile_memory_heap[]
...
ifdef::VK_ARM_tensors[]
  * [[VUID-VkImageCreateInfo-tiling-09711]]
    If pname:tiling is VK_IMAGE_TILING_LINEAR then
    ename:VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM must: not be set in
    pname:usage
endif::VK_ARM_tensors[]
ifdef::VK_KHR_maintenance11[]
  * [[VUID-VkImageCreateInfo-flags-13355]]
    If pname:flags contains
    ename:VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR, the
    <<features-maintenance11,pname:maintenance11>> feature must: be enabled
  * [[VUID-VkImageCreateInfo-flags-13356]]
    If pname:flags contains
    ename:VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR,
    pname:imageType must: be ename:VK_IMAGE_TYPE_1D or
    ename:VK_IMAGE_TYPE_2D
endif::VK_KHR_maintenance11[]
ifdef::VK_EXT_ycbcr_2plane_444_formats[]
...
ifdef::VK_EXT_descriptor_heap[]
  * [[VUID-VkImageCreateInfo-flags-11281]]
    ...
    ename:VK_IMAGE_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_EXT
  * [[VUID-VkImageCreateInfo-pData-11286]]
    If pname:flags contains
    ename:VK_IMAGE_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_EXT, and
    slink:VkOpaqueCaptureDataCreateInfoEXT::pname:pData is not `NULL`,
    slink:VkOpaqueCaptureDataCreateInfoEXT::pname:pData->size must: be equal
    to <<limits-imageCaptureReplayOpaqueDataSize,
    pname:imageCaptureReplayOpaqueDataSize>>
endif::VK_EXT_descriptor_heap[]
ifdef::VK_EXT_image_tiling_control+VK_EXT_image_drm_format_modifier[]
  * [[VUID-VkImageCreateInfo-pNext-12480]]
    If the pname:pNext chain includes a
    slink:VkImageTilingControlCreateInfoEXT structure, then the pname:pNext
    chain must: not include a
    slink:VkImageDrmFormatModifierExplicitCreateInfoEXT structure
endif::VK_EXT_image_tiling_control+VK_EXT_image_drm_format_modifier[]
ifdef::VK_KHR_extended_flags[]
  * [[VUID-VkImageCreateInfo-pNext-12442]]
    pname:pNext must: contain at most one of the structures
    slink:VkImageStencilUsageCreateInfo and
    slink:VkImageStencilUsage2CreateInfoKHR
endif::VK_KHR_extended_flags[]
****
ifdef::VKSC_VERSION_1_0[]
ifdef::hidden[]
...
ifdef::VK_KHR_extended_flags[]
[open,refpage='VkImageCreateFlags2CreateInfoKHR',desc='Extended image usage flags',type='structs']
--
The sname:VkImageCreateFlags2CreateInfoKHR structure is defined as:

include::{generated}/api/structs/VkImageCreateFlags2CreateInfoKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:flags is a bitmask of elink:VkImageCreateFlagBits2KHR specifying
    creation flags of the image.

If this structure is included in the pname:pNext chain of an image creation
structure, pname:flags is used instead of the corresponding pname:flags
value passed in that creation structure, allowing additional create flags to
be specified.

If this structure is included in the pname:pNext chain of a query structure
including tlink:VkImageCreateFlags, the create flags of the image are
returned in pname:flags of this structure, allowing additional create flags
to be queried.
The flags representable in tlink:VkImageCreateFlags are still returned in
the query structure in this case.

include::{generated}/validity/structs/VkImageCreateFlags2CreateInfoKHR.adoc[]
--

[open,refpage='VkImageUsageFlags2CreateInfoKHR',desc='Extended image usage flags',type='structs']
--
The sname:VkImageUsageFlags2CreateInfoKHR structure is defined as:

include::{generated}/api/structs/VkImageUsageFlags2CreateInfoKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:usage is a bitmask of elink:VkImageUsageFlagBits2KHR specifying
...
If this structure is included in the pname:pNext chain of a query structure
including tlink:VkImageCreateFlags, the usage flags of the image are
returned in pname:flags of this structure, allowing additional usage flags
to be queried.
The flags representable in tlink:VkImageUsageFlags are still returned in the
query structure in this case.

include::{generated}/validity/structs/VkImageUsageFlags2CreateInfoKHR.adoc[]
--
endif::VK_KHR_extended_flags[]
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_EXT_separate_stencil_usage[]
[open,refpage='VkImageStencilUsageCreateInfo',desc='Specify separate usage flags for the stencil aspect of a depth-stencil image',type='structs']
--
...
ifdef::VK_KHR_extended_flags[]
[open,refpage='VkImageStencilUsage2CreateInfoKHR',desc='Specify separate 64-bit usage flags for the stencil aspect of a depth-stencil image',type='structs']
--
The sname:VkImageStencilUsage2CreateInfoKHR structure is defined as:

include::{generated}/api/structs/VkImageStencilUsage2CreateInfoKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:stencilUsage is a bitmask of elink:VkImageUsageFlagBits2KHR
    describing the intended usage of the stencil aspect of the image.

If the pname:pNext chain of slink:VkImageCreateInfo includes a
sname:VkImageStencilUsage2CreateInfoKHR structure, then that structure
...
****
  * [[VUID-VkImageStencilUsage2CreateInfoKHR-stencilUsage-12443]]
    If pname:stencilUsage includes
    ename:VK_IMAGE_USAGE_2_TRANSIENT_ATTACHMENT_BIT_KHR, it must: not
    include bits other than
    ename:VK_IMAGE_USAGE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR or
    ename:VK_IMAGE_USAGE_2_INPUT_ATTACHMENT_BIT_KHR
****

include::{generated}/validity/structs/VkImageStencilUsage2CreateInfoKHR.adoc[]
--
endif::VK_KHR_extended_flags[]
endif::VK_GRAPHICS_VERSION_1_2,VK_EXT_separate_stencil_usage[]
...
ifdef::VK_BASE_VERSION_1_2,VK_KHR_image_format_list[]
[open,refpage='VkImageFormatListCreateInfo',desc='Specify that an image can: be used with a particular set of formats',type='structs']
--
If the pname:pNext chain of slink:VkImageCreateInfo includes a
...
ifdef::VK_EXT_image_tiling_control[]
can: be influenced by also including a
slink:VkImageTilingControlCreateInfoEXT structure in the pname:pNext chain,
but otherwise, it
endif::VK_EXT_image_tiling_control[]
...
compression rates per plane of a <<formats-multiplanar, multi-planar
format>> and will not be able to enable fixed-rate compression for any plane
...
the slink:VkSubresourceLayout2 structure in a call to
flink:vkGetImageSubresourceLayout2.
...
pname:maximumRequestedAlignment to be honored - where a larger alignment
would enable image compression - the implementation should: not use
pname:maximumRequestedAlignment, and should: return the smallest alignment
which does not compromise compression.
ifdef::VK_EXT_image_compression_control[]
If the <<features-imageCompressionControl,pname:imageCompressionControl>>
feature is enabled, the application can: chain a
slink:VkImageCompressionControlEXT with
ename:VK_IMAGE_COMPRESSION_DISABLED_EXT.
...
ifdef::VK_EXT_image_tiling_control[]
[open,refpage='VkImageTilingControlCreateInfoEXT',desc='Specifies additional creation parameters for image tiling',type='structs']
--
If the pname:pNext chain of slink:VkImageCreateInfo includes a
sname:VkImageTilingControlCreateInfoEXT structure, then that structure
specifies the optimal tiling arrangement for this image.

The sname:VkImageTilingControlCreateInfoEXT structure is defined as:

include::{generated}/api/structs/VkImageTilingControlCreateInfoEXT.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:imageTiling is a elink:VkImageTilingControlEXT value specifying
    the optimal tiling arrangement for the image.

.Valid Usage
****
  * [[VUID-VkImageTilingControlCreateInfoEXT-imageTiling-12481]]
    If sname:VkImageTilingControlCreateInfoEXT::pname:imageTiling is not
    ename:VK_IMAGE_TILING_CONTROL_DEFAULT_EXT, the
    <<features-imageTilingControl, pname:imageTilingControl>> feature must:
    be enabled
  * [[VUID-VkImageTilingControlCreateInfoEXT-imageTiling-12479]]
    If sname:VkImageTilingControlCreateInfoEXT::pname:imageTiling is not
    ename:VK_IMAGE_TILING_CONTROL_DEFAULT_EXT,
    slink:VkImageCreateInfo::pname:tiling must: not be
    ename:VK_IMAGE_TILING_LINEAR
****

include::{generated}/validity/structs/VkImageTilingControlCreateInfoEXT.adoc[]
--

[open,refpage='VkImageTilingControlEXT',desc='Specifies image tiling arrangement',type='enums']
--
Possible values of
slink:VkImageTilingControlCreateInfoEXT::pname:imageTiling, specifying image
tiling arrangement, are:

include::{generated}/api/enums/VkImageTilingControlEXT.adoc[]

  * ename:VK_IMAGE_TILING_CONTROL_DEFAULT_EXT specifies that the image
    tiling arrangement balances memory size requirements and memory access
    performance.
    It is the same selection as with the
    slink:VkImageTilingControlCreateInfoEXT structure omitted from the
    pname:pNext chain of slink:VkImageCreateInfo.
  * ename:VK_IMAGE_TILING_CONTROL_MIN_SIZE_EXT specifies that the image
    tiling arrangement minimizes memory size requirements with reduced
    consideration for memory access performance.
  * ename:VK_IMAGE_TILING_CONTROL_MAX_PERFORMANCE_EXT specifies that the
...
ename:VK_IMAGE_TILING_CONTROL_MIN_SIZE_EXT.
However, there are no performance guarantees when using
ename:VK_IMAGE_TILING_CONTROL_MAX_PERFORMANCE_EXT as image access times are
dependent on other variables such as the shader access pattern.
--
endif::VK_EXT_image_tiling_control[]

ifdef::VK_KHR_extended_flags[]
[open,refpage='VkImageUsageFlagBits2KHR',desc='Bitmask specifying intended use of an image',type='enums']
--
Bits which can: be set in
slink:VkImageUsageFlags2CreateInfoKHR::pname:usage, specifying intended
usage of an image, are:

include::{generated}/api/enums/VkImageUsageFlagBits2KHR.adoc[]

// Note - when editing this section, make sure that any relevant changes
// are mirrored between VkImageUsageFlagBits2KHR/VkImageUsageFlagBits

  * ename:VK_IMAGE_USAGE_2_TRANSFER_SRC_BIT_KHR specifies that the image
    can: be used as the source of a transfer command.
  * ename:VK_IMAGE_USAGE_2_TRANSFER_DST_BIT_KHR specifies that the image
    can: be used as the destination of a transfer command.
  * ename:VK_IMAGE_USAGE_2_SAMPLED_BIT_KHR specifies that the image can: be
    ...
    shader.
  * ename:VK_IMAGE_USAGE_2_STORAGE_BIT_KHR specifies that the image can: be
    used to create a sname:VkImageView suitable for occupying a
    sname:VkDescriptorSet slot of type
    ename:VK_DESCRIPTOR_TYPE_STORAGE_IMAGE.
  * ename:VK_IMAGE_USAGE_2_COLOR_ATTACHMENT_BIT_KHR specifies that the image
    can: be used to create a sname:VkImageView suitable for use as a color
    or resolve attachment in a sname:VkFramebuffer.
  * ename:VK_IMAGE_USAGE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR specifies that
    the image can: be used to create a sname:VkImageView suitable for use as
    a depth/stencil
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_depth_stencil_resolve[]
  ...
  * ename:VK_IMAGE_USAGE_2_TRANSIENT_ATTACHMENT_BIT_KHR specifies that
    ...
    or input attachment.
  * ename:VK_IMAGE_USAGE_2_INPUT_ATTACHMENT_BIT_KHR specifies that the image
...
ifdef::VK_EXT_fragment_density_map[]
  * ename:VK_IMAGE_USAGE_2_FRAGMENT_DENSITY_MAP_BIT_EXT specifies that the
    image can: be used to create a sname:VkImageView suitable for use as a
    <<fragmentdensitymapops, fragment density map image>>.
endif::VK_EXT_fragment_density_map[]
ifdef::VK_KHR_fragment_shading_rate,VK_NV_shading_rate_image[]
  * ename:VK_IMAGE_USAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR
    specifies that the image can: be used to create a sname:VkImageView
...
ifdef::VK_KHR_video_decode_queue[]
  * ename:VK_IMAGE_USAGE_2_VIDEO_DECODE_DST_BIT_KHR specifies that the image
    can: be used as a <<decode-output-picture,decode output picture>> in a
    <<video-decode-operations,video decode operation>>.
  * ename:VK_IMAGE_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR is reserved for future
    use.
  * ename:VK_IMAGE_USAGE_2_VIDEO_DECODE_DPB_BIT_KHR specifies that the image
    can: be used as an output <<reconstructed-picture,reconstructed
    picture>> or an input <<reference-picture,reference picture>> in a
    <<video-decode-operations,video decode operation>>.
endif::VK_KHR_video_decode_queue[]
ifdef::VK_KHR_video_encode_queue[]
  * ename:VK_IMAGE_USAGE_2_VIDEO_ENCODE_DST_BIT_KHR is reserved for future
    use.
  * ename:VK_IMAGE_USAGE_2_VIDEO_ENCODE_SRC_BIT_KHR specifies that the image
    can: be used as an <<encode-input-picture,encode input picture>> in a
    <<video-encode-operations,video encode operation>>.
  * ename:VK_IMAGE_USAGE_2_VIDEO_ENCODE_DPB_BIT_KHR specifies that the image
    can: be used as an output <<reconstructed-picture,reconstructed
    picture>> or an input <<reference-picture,reference picture>> in a
    <<video-encode-operations,video encode operation>>.
endif::VK_KHR_video_encode_queue[]
ifdef::VK_EXT_attachment_feedback_loop_layout[]
  * ename:VK_IMAGE_USAGE_2_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT specifies that
    the image can: be used as a color or depth/stencil attachment with
    <<renderpass-feedbackloop,feedback loop enabled>>.
endif::VK_EXT_attachment_feedback_loop_layout[]
ifdef::VK_QCOM_tile_memory_heap[]
  * ename:VK_IMAGE_USAGE_2_TILE_MEMORY_BIT_QCOM specifies that the image
    can: be bound to sname:VkDeviceMemory allocated from a
    slink:VkMemoryHeap with the ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM
    property.
endif::VK_QCOM_tile_memory_heap[]
ifdef::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
  * ename:VK_IMAGE_USAGE_2_HOST_TRANSFER_BIT_KHR specifies that the image
    can: be used with host copy commands and host layout transitions.
endif::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
ifdef::VK_KHR_video_encode_quantization_map[]
  * ename:VK_IMAGE_USAGE_2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR
    specifies that the image can: be used as a
    <<encode-quantization-delta-map,quantization delta map>> in a
    <<video-encode-operations,video encode operation>>.
  * ename:VK_IMAGE_USAGE_2_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR specifies that
    the image can: be used as an <<encode-emphasis-map,emphasis map>> in a
    <<video-encode-operations,video encode operation>>.
endif::VK_KHR_video_encode_quantization_map[]
ifdef::VK_ARM_tensors[]
  * ename:VK_IMAGE_USAGE_2_TENSOR_ALIASING_BIT_ARM specifies that the image
    can: be transitioned to the ename:VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM
    layout.
    See <<resources-memory-aliasing>> for a complete set of rules for
    tensor/image aliasing.
endif::VK_ARM_tensors[]
--

[open,refpage='VkImageUsageFlags2KHR',desc='Bitmask of VkImageUsageFlagBits2',type='flags']
--
include::{generated}/api/flags/VkImageUsageFlags2KHR.adoc[]

tname:VkImageUsageFlags2KHR is a bitmask type for setting a mask of zero or
more elink:VkImageUsageFlagBits2KHR.
--
endif::VK_KHR_extended_flags[]
...
ifdef::VK_QCOM_image_processing[]
  * ename:VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM specifies that the image
    can: be used in <<textures-weightimage,weight image sampling
    operations>>.
  * ename:VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM specifies that the
    image can: be used in <<textures-blockmatch,block matching operations>>.
endif::VK_QCOM_image_processing[]
ifdef::VK_QCOM_tile_memory_heap[]
  * ename:VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM specifies that the image can:
    be bound to sname:VkDeviceMemory allocated from a slink:VkMemoryHeap
    with the ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM property.
endif::VK_QCOM_tile_memory_heap[]
ifdef::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
  * ename:VK_IMAGE_USAGE_HOST_TRANSFER_BIT specifies that the image can: be
...
ifdef::VK_KHR_video_encode_quantization_map[]
  * ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR
    ...
    <<encode-quantization-delta-map,quantization delta map>> in a
    <<video-encode-operations,video encode operation>>.
  * ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR specifies that
    the image can: be used as an <<encode-emphasis-map,emphasis map>> in a
    <<video-encode-operations,video encode operation>>.
endif::VK_KHR_video_encode_quantization_map[]
ifdef::VK_ARM_tensors[]
  * ename:VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM specifies that the image
    can: be transitioned to the ename:VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM
    layout.
    See <<resources-memory-aliasing>> for a complete set of rules for
    tensor/image aliasing.
...
ifdef::VK_KHR_extended_flags[]
[open,refpage='VkImageCreateFlagBits2KHR',desc='Bitmask specifying additional parameters of an image',type='enums']
--
Bits which can: be set in
slink:VkImageCreateFlags2CreateInfoKHR::pname:flags, specifying additional
parameters of an image, are:

include::{generated}/api/enums/VkImageCreateFlagBits2KHR.adoc[]

// Note - when editing this section, make sure that any relevant changes
// are mirrored between VkImageCreateFlagBits2KHR/VkImageCreateFlagBits

  * ename:VK_IMAGE_CREATE_2_SPARSE_BINDING_BIT_KHR specifies that the image
    will be backed using sparse memory binding.
ifdef::VKSC_VERSION_1_0[]
    This flag is not supported in Vulkan SC <<SCID-8>>.
endif::VKSC_VERSION_1_0[]
  * ename:VK_IMAGE_CREATE_2_SPARSE_RESIDENCY_BIT_KHR specifies that the
    image can: be partially backed using sparse memory binding.
    Images created with this flag must: also be created with the
    ename:VK_IMAGE_CREATE_2_SPARSE_BINDING_BIT_KHR flag.
ifdef::VKSC_VERSION_1_0[]
    This flag is not supported in Vulkan SC <<SCID-8>>.
endif::VKSC_VERSION_1_0[]
  * ename:VK_IMAGE_CREATE_2_SPARSE_ALIASED_BIT_KHR specifies that the image
...
ifdef::VKSC_VERSION_1_0[]
  ...
  * ename:VK_IMAGE_CREATE_2_MUTABLE_FORMAT_BIT_KHR specifies that the image
    can: be used to create a sname:VkImageView with a different format from
    the image.
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
    For <<formats-multiplanar, multi-planar formats>>,
    ename:VK_IMAGE_CREATE_2_MUTABLE_FORMAT_BIT_KHR specifies that a
    sname:VkImageView can be created of a _plane_ of the image.
endif::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * ename:VK_IMAGE_CREATE_2_CUBE_COMPATIBLE_BIT_KHR specifies that the image
    can: be used to create a sname:VkImageView of type
    ename:VK_IMAGE_VIEW_TYPE_CUBE or ename:VK_IMAGE_VIEW_TYPE_CUBE_ARRAY.
ifdef::VK_BASE_VERSION_1_1,VK_KHR_maintenance1[]
  * ename:VK_IMAGE_CREATE_2_2D_ARRAY_COMPATIBLE_BIT_KHR specifies that the
    image can: be used to create a sname:VkImageView of type
    ename:VK_IMAGE_VIEW_TYPE_2D or ename:VK_IMAGE_VIEW_TYPE_2D_ARRAY.
endif::VK_BASE_VERSION_1_1,VK_KHR_maintenance1[]
ifdef::VK_EXT_image_2d_view_of_3d[]
  * ename:VK_IMAGE_CREATE_2_2D_VIEW_COMPATIBLE_BIT_EXT specifies that the
    image can: be used to create a sname:VkImageView of type
    ename:VK_IMAGE_VIEW_TYPE_2D.
endif::VK_EXT_image_2d_view_of_3d[]
ifdef::VK_BASE_VERSION_1_1[]
  * ename:VK_IMAGE_CREATE_2_PROTECTED_BIT_KHR specifies that the image is a
    protected image.
endif::VK_BASE_VERSION_1_1[]
ifdef::VK_BASE_VERSION_1_1,VK_KHR_device_group[]
  * ename:VK_IMAGE_CREATE_2_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR specifies
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
  * ename:VK_IMAGE_CREATE_2_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR specifies
  ...
  * ename:VK_IMAGE_CREATE_2_EXTENDED_USAGE_BIT_KHR specifies that the image
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * ename:VK_IMAGE_CREATE_2_DISJOINT_BIT_KHR specifies that an image with a
    <<formats-multiplanar, multi-planar format>> must: have each plane
    separately bound to memory, rather than having a single memory binding
    for the whole image; the presence of this bit distinguishes a _disjoint
    image_ from an image without this bit set.
endif::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
ifdef::VK_BASE_VERSION_1_1,VK_KHR_bind_memory2[]
  * ename:VK_IMAGE_CREATE_2_ALIAS_BIT_KHR specifies that two images created
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_external_memory,VK_NV_external_memory[]
    If the pname:pNext chain includes a
ifdef::VK_BASE_VERSION_1_1,VK_KHR_external_memory[slink:VkExternalMemoryImageCreateInfo]
...
ifdef::VK_NV_external_memory[slink:VkExternalMemoryImageCreateInfoNV]
    ...
    ename:VK_IMAGE_CREATE_2_ALIAS_BIT_KHR is set.
endif::VK_BASE_VERSION_1_1,VK_KHR_external_memory,VK_NV_external_memory[]
endif::VK_BASE_VERSION_1_1,VK_KHR_bind_memory2[]
ifdef::VK_EXT_sample_locations[]
  * ename:VK_IMAGE_CREATE_2_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT
...
ifdef::VK_NV_corner_sampled_image[]
  * ename:VK_IMAGE_CREATE_2_CORNER_SAMPLED_BIT_NV specifies that the image
    is a <<resources-images-corner-sampled,corner-sampled image>>.
endif::VK_NV_corner_sampled_image[]
ifdef::VK_EXT_fragment_density_map[]
  * ename:VK_IMAGE_CREATE_2_SUBSAMPLED_BIT_EXT specifies that an image can:
...
ifdef::VK_QCOM_fragment_density_map_offset,VK_EXT_fragment_density_map_offset[]
  * ename:VK_IMAGE_CREATE_2_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT specifies
    ...
    created with
    ename:VK_IMAGE_CREATE_2_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT.
endif::VK_QCOM_fragment_density_map_offset,VK_EXT_fragment_density_map_offset[]
endif::VK_EXT_fragment_density_map[]
ifdef::VK_EXT_descriptor_buffer[]
  * ename:VK_IMAGE_CREATE_2_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT
    specifies that the image can: be used with descriptor buffers when
    capturing and replaying (e.g. for trace capture and replay), see
    slink:VkOpaqueCaptureDescriptorDataCreateInfoEXT for more detail.
endif::VK_EXT_descriptor_buffer[]
ifdef::VK_EXT_multisampled_render_to_single_sampled[]
  * ename:VK_IMAGE_CREATE_2_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT
...
ifdef::VK_KHR_video_maintenance1[]
  * ename:VK_IMAGE_CREATE_2_VIDEO_PROFILE_INDEPENDENT_BIT_KHR specifies that
...
ifdef::VK_KHR_video_decode_queue[]
  * <<decode-output-picture,Decode output pictures>>, regardless of the
    video profile used to produce them.
endif::VK_KHR_video_decode_queue[]
ifdef::VK_KHR_video_encode_queue[]
  * <<encode-input-picture,Encode input pictures>>, regardless of the video
...
[open,refpage='VkImageCreateFlags2KHR',desc='Bitmask of VkImageCreateFlagBits2',type='flags']
--
include::{generated}/api/flags/VkImageCreateFlags2KHR.adoc[]

tname:VkImageCreateFlags2KHR is a bitmask type for setting a mask of zero or
more elink:VkImageCreateFlagBits2KHR.
--
endif::VK_KHR_extended_flags[]
...
ifdef::VK_EXT_fragment_density_map[]
  ...
  ** Image data read as an image sampler will have undefined: values if the
     ...
     ename:VK_SAMPLER_CREATE_SUBSAMPLED_BIT_EXT or was not sampled through
ifdef::VK_EXT_descriptor_heap[]
     a combined <<VkDescriptorSetAndBindingMappingEXT, embedded sampler and
     image mapping>> if using descriptor heaps, or
endif::VK_EXT_descriptor_heap[]
     the use of a combined image sampler with an immutable sampler in
     sname:VkDescriptorSetLayoutBinding.
  ** Image data read with an input attachment will have undefined: values if
...
ifndef::VK_EXT_fragment_density_map2[]
  ...
  ** Image contents outside of the render area take on undefined: values if
     the image is stored as a render pass attachment.
ifdef::VK_QCOM_fragment_density_map_offset,VK_EXT_fragment_density_map_offset[]
  * ename:VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT specifies that
    an image can: be used in a render pass with non-zero
    <<renderpass-fragmentdensitymapoffsets,fragment density map offsets>>.
    In a render pass with non-zero offsets, fragment density map
    attachments, input attachments, color attachments, depth/stencil
    attachment, resolve attachments, and preserve attachments must: be
    created with ename:VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT.
endif::VK_QCOM_fragment_density_map_offset,VK_EXT_fragment_density_map_offset[]
endif::VK_EXT_fragment_density_map[]
ifdef::VK_EXT_descriptor_buffer[]
...
ifdef::VK_EXT_multisampled_render_to_single_sampled[]
  * ename:VK_IMAGE_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT
    specifies that an image can: be used with
    <<multisampled-render-to-single-sampled,multisampled rendering as a
    single-sampled render pass attachment>>
endif::VK_EXT_multisampled_render_to_single_sampled[]
ifdef::VK_KHR_maintenance11[]
  * ename:VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR specifies
    that a single layer image view created from this image can be accessed
    with both code:Arrayed equal to 0 and code:Arrayed equal to 1 in a
    shader.
    If accessed with code:Arrayed equal to 1 in a shader, and
    slink:VkImageViewCreateInfo::pname:viewType is
    ename:VK_IMAGE_VIEW_TYPE_1D or ename:VK_IMAGE_VIEW_TYPE_2D, the image is
    treated as having an array size of `1`, and
    pname:subresourceRange.baseArrayLayer is accessed.
    If accessed with code:Arrayed equal to 0 in a shader, and
    slink:VkImageViewCreateInfo::pname:viewType is
    ename:VK_IMAGE_VIEW_TYPE_1D_ARRAY or ename:VK_IMAGE_VIEW_TYPE_2D_ARRAY,
    the descriptor is accessed as-if the view was created with
    ename:VK_IMAGE_VIEW_TYPE_1D or ename:VK_IMAGE_VIEW_TYPE_2D respectively.
    Cube map view aliasing is not included by this flag bit.
ifdef::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
    Also, image views created with a <<formats-multiplanar, multi-planar
    format>> can: not alias like this.
...
include::{generated}/api/enums/VkImageTiling.adoc[]
  ...
  * ename:VK_IMAGE_TILING_LINEAR specifies linear tiling (texels are laid
    ...
    row).
ifdef::VK_EXT_image_drm_format_modifier[]
  * ename:VK_IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT specifies that the image's
...
format is a <<formats-multiplanar, multi-planar format>>, then
fname:vkGetImageSubresourceLayout describes one
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
If the image has a <<formats-multiplanar, multi-planar format>>
ifdef::VK_EXT_image_drm_format_modifier[]
and its tiling is ename:VK_IMAGE_TILING_LINEAR
endif::VK_EXT_image_drm_format_modifier[]
, then the pname:aspectMask member of sname:VkImageSubresource must: be
...
ifdef::VK_BASE_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_host_image_copy,VK_EXT_image_compression_control[]
[open,refpage='vkGetImageSubresourceLayout2',desc='Retrieve information about an image subresource',type='protos']
--
:refpage: vkGetImageSubresourceLayout2

To query the memory layout of an image subresource, call:

ifdef::VK_BASE_VERSION_1_4[]
include::{generated}/api/protos/vkGetImageSubresourceLayout2.adoc[]
...
ifdef::VK_EXT_host_image_copy,VK_EXT_image_compression_control[]
include::{generated}/api/protos/vkGetImageSubresourceLayout2EXT.adoc[]
  ...
  * pname:pLayout is a pointer to a slink:VkSubresourceLayout2 structure in
    which the layout is returned.

fname:vkGetImageSubresourceLayout2 behaves similarly to
...
It is legal to call fname:vkGetImageSubresourceLayout2 with an pname:image
created with pname:tiling equal to ename:VK_IMAGE_TILING_OPTIMAL, but the
members of slink:VkSubresourceLayout2::pname:subresourceLayout will have
undefined: values in this case.

[NOTE]
====
Structures chained from slink:VkImageSubresource2::pname:pNext will also be
updated when pname:tiling is equal to ename:VK_IMAGE_TILING_OPTIMAL.
====
...
include::{generated}/validity/protos/vkGetImageSubresourceLayout2.adoc[]
--

[open,refpage='VkImageSubresource2',desc='Structure specifying an image subresource',type='structs']
--
The sname:VkImageSubresource2 structure is defined as:

include::{generated}/api/structs/VkImageSubresource2.adoc[]
...
include::{generated}/validity/structs/VkImageSubresource2.adoc[]
--

[open,refpage='VkSubresourceLayout2',desc='Structure specifying subresource layout',type='structs']
--
Information about the layout of the image subresource is returned in a
sname:VkSubresourceLayout2 structure:

include::{generated}/api/structs/VkSubresourceLayout2.adoc[]
...
include::{generated}/validity/structs/VkSubresourceLayout2.adoc[]
--

ifdef::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
[open,refpage='VkSubresourceHostMemcpySize',desc='Memory size needed to copy to or from an image on the host with VK_HOST_IMAGE_COPY_MEMCPY_BIT',type='structs']
--
To query the memory size needed to copy to or from an image using
flink:vkCopyMemoryToImage or flink:vkCopyImageToMemory when the
ename:VK_HOST_IMAGE_COPY_MEMCPY_BIT flag is specified, add a
slink:VkSubresourceHostMemcpySize structure to the pname:pNext chain of the
slink:VkSubresourceLayout2 structure in a call to
flink:vkGetImageSubresourceLayout2.

The sname:VkSubresourceHostMemcpySize structure is defined as:

include::{generated}/api/structs/VkSubresourceHostMemcpySize.adoc[]
...
include::{generated}/validity/structs/VkSubresourceHostMemcpySize.adoc[]
--
endif::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
endif::VK_BASE_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_host_image_copy,VK_EXT_image_compression_control[]

ifdef::VK_BASE_VERSION_1_4,VK_KHR_maintenance5[]
[open,refpage='vkGetDeviceImageSubresourceLayout',desc='Retrieve information about an image subresource without an image object',type='protos']
--
To query the memory layout of an image subresource, without an image object,
call:

ifdef::VK_BASE_VERSION_1_4[]
include::{generated}/api/protos/vkGetDeviceImageSubresourceLayout.adoc[]
endif::VK_BASE_VERSION_1_4[]
...
include::{generated}/api/protos/vkGetDeviceImageSubresourceLayoutKHR.adoc[]
  ...
  * pname:device is the logical device that owns the image.
  * pname:pInfo is a pointer to a slink:VkDeviceImageSubresourceInfo
    structure containing parameters required for the subresource layout
    query.
  * pname:pLayout is a pointer to a slink:VkSubresourceLayout2 structure in
    which the layout is returned.

fname:vkGetDeviceImageSubresourceLayout behaves similarly to
flink:vkGetImageSubresourceLayout2, but uses a slink:VkImageCreateInfo
structure to specify the image rather than a slink:VkImage object.

include::{generated}/validity/protos/vkGetDeviceImageSubresourceLayout.adoc[]
--

[open,refpage='VkDeviceImageSubresourceInfo',desc='Image creation information for querying subresource layout',type='structs']
--
:refpage: VkDeviceImageSubresourceInfo

The sname:VkDeviceImageSubresourceInfo structure is defined as:

include::{generated}/api/structs/VkDeviceImageSubresourceInfo.adoc[]
...
include::{generated}/validity/structs/VkDeviceImageSubresourceInfo.adoc[]
--
...
ifdef::VK_EXT_descriptor_heap[]
[[resources-images-heapcapturereplay]]
=== Image Capture Replay for Descriptor Heaps

To allow for a replay tool to capture and replay image descriptors used with
<<descriptorheaps, descriptor heaps>>, opaque data must: be captured during
the initial recording and provided when recreating the image during replay,
using the following functions:

[open,refpage='vkGetImageOpaqueCaptureDataEXT',desc='Get image opaque capture descriptor data for descriptor heap replay',type='protos']
--
To get the opaque capture descriptor data for images, call:

include::{generated}/api/protos/vkGetImageOpaqueCaptureDataEXT.adoc[]

  * pname:device is the logical device that gets the data.
  * pname:imageCount is the number of images to retrieve data from.
  * pname:pImages is a pointer to an array of slink:VkImage objects to
    retrieve the opaque capture data from.
  * pname:pDatas is a pointer to an array of slink:VkHostAddressRangeEXT
...
****
  * [[VUID-vkGetImageOpaqueCaptureDataEXT-descriptorHeapCaptureReplay-11282]]
    The <<features-descriptorHeapCaptureReplay,
    pname:descriptorHeapCaptureReplay>> feature must: be enabled
  * [[VUID-vkGetImageOpaqueCaptureDataEXT-size-11283]]
    The pname:size member of each element of pname:pDatas must: be equal to
  ...
  * [[VUID-vkGetImageOpaqueCaptureDataEXT-pImages-11285]]
    Each element of pname:pImages must: have been created with
    ename:VK_IMAGE_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_EXT set in
    slink:VkImageCreateInfo::pname:flags
****

include::{generated}/validity/protos/vkGetImageOpaqueCaptureDataEXT.adoc[]
--


[open,refpage='VkOpaqueCaptureDataCreateInfoEXT',desc='Structure specifying opaque capture data',type='structs']
--
The sname:VkOpaqueCaptureDataCreateInfoEXT structure is defined as:

include::{generated}/api/structs/VkOpaqueCaptureDataCreateInfoEXT.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:pData is a pointer to the range of host memory containing opaque
    data previously captured via flink:vkGetImageOpaqueCaptureDataEXT.

When an image is created with
ename:VK_IMAGE_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_EXT set in
slink:VkImageCreateInfo::pname:flags, if the pname:pNext chain of
slink:VkImageCreateInfo includes this structure, and pname:pData is not
`NULL`, the implementation will attempt to recreate the image such that
descriptors written with flink:vkWriteResourceDescriptorsEXT will be
...
ename:VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS.

ifdef::VK_ARM_tensors[]
When a tensor is created with
ename:VK_TENSOR_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_ARM set in
slink:VkTensorCreateInfoARM::pname:flags, if the pname:pNext chain of
slink:VkTensorCreateInfoARM includes this structure, and pname:pData is not
...
If this structure is not present, it is equivalent to setting pname:pData to
`NULL`.

include::{generated}/validity/structs/VkOpaqueCaptureDataCreateInfoEXT.adoc[]
--


ifdef::VK_ARM_tensors[]
[[resources-tensors-heapcapturereplay]]
=== Tensor Capture Replay for Descriptor Heaps

To allow for a replay tool to capture and replay tensor descriptors used
with <<descriptorheaps, descriptor heaps>>, opaque data must: be captured
during the initial recording and provided when recreating the tensor during
replay, using the following functions:

[open,refpage='vkGetTensorOpaqueCaptureDataARM',desc='Get tensor opaque capture descriptor data for descriptor heap replay',type='protos']
--
To get the opaque capture descriptor data for tensors, call:

include::{generated}/api/protos/vkGetTensorOpaqueCaptureDataARM.adoc[]

  * pname:device is the logical device that gets the data.
  * pname:tensorCount is the number of tensors to retrieve data from.
  * pname:pTensors is a pointer to an array of slink:VkTensorARM objects to
    retrieve the opaque capture data from.
  * pname:pDatas is a pointer to an array of slink:VkHostAddressRangeEXT
...
****
  ...
  * [[VUID-vkGetTensorOpaqueCaptureDataARM-size-11392]]
    ...
    pname:tensorCaptureReplayOpaqueDataSize>>
  * [[VUID-vkGetTensorOpaqueCaptureDataARM-device-11393]]
    If pname:device was created with multiple physical devices, then the
    <<features-bufferDeviceAddressMultiDevice,
    pname:bufferDeviceAddressMultiDevice>> feature must: be enabled
  * [[VUID-vkGetTensorOpaqueCaptureDataARM-pTensors-11394]]
    Each element of pname:pTensors must: have been created with
    ename:VK_TENSOR_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_ARM set in
    slink:VkTensorCreateInfoARM::pname:flags
****

include::{generated}/validity/protos/vkGetTensorOpaqueCaptureDataARM.adoc[]
--
endif::VK_ARM_tensors[]
endif::VK_EXT_descriptor_heap[]
...
feature is enabled.
When an sname:VkImageView descriptor is accessed on the device, all image
...
The pname:initialLayout must: be either ename:VK_IMAGE_LAYOUT_UNDEFINED,
ifdef::VK_EXT_zero_initialize_device_memory[ename:VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT,]
or ename:VK_IMAGE_LAYOUT_PREINITIALIZED.
If it is ename:VK_IMAGE_LAYOUT_PREINITIALIZED and the image has linear
...
data.
ifdef::VK_EXT_zero_initialize_device_memory[]
If it is ename:VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT, then the image data is
...
ifdef::VK_EXT_zero_initialize_device_memory[]
  * ename:VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT
endif::VK_EXT_zero_initialize_device_memory[]
...
The type(s) of device access supported by each layout are:
  ...
  * ename:VK_IMAGE_LAYOUT_PREINITIALIZED specifies that a linear image's
    memory is in a defined layout and can: be populated by data, but that it
    has not yet been initialized by the driver.
    Image memory cannot: be transitioned into this layout.
    This layout can: be used as the pname:initialLayout member of
    slink:VkImageCreateInfo when pname:tiling is
    ename:VK_IMAGE_TILING_LINEAR.
...
ifdef::VK_EXT_zero_initialize_device_memory[]
  * ename:VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT specifies that an image's
    ...
    ename:VK_MEMORY_ALLOCATE_ZERO_INITIALIZE_BIT_EXT.
endif::VK_EXT_zero_initialize_device_memory[]
ifdef::VK_BASE_VERSION_1_3,VK_KHR_synchronization2[]
  ...
  * ename:VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL must: only be used as a
    ...
    the ename:VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT usage flag set.
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_separate_depth_stencil_layouts[]
  ...
  * ename:VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL must: only be used as a
    ...
    ename:VK_PIPELINE_STAGE_TRANSFER_BIT>>).
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_TRANSFER_SRC_BIT usage flag set.
  * ename:VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL must: only be used as a
    destination image of a transfer command.
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_TRANSFER_DST_BIT usage flag set.
ifdef::VK_KHR_swapchain[]
...
ifdef::VK_EXT_fragment_density_map[]
  * ename:VK_IMAGE_LAYOUT_FRAGMENT_DENSITY_MAP_OPTIMAL_EXT must: only be
    ...
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT usage flag set.
endif::VK_EXT_fragment_density_map[]
ifdef::VK_KHR_video_decode_queue[]
  * ename:VK_IMAGE_LAYOUT_VIDEO_DECODE_DST_KHR must: only be used as a
    ...
    <<video-decode-operations,video decode operation>>.
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR usage flag set.
  ...
  * ename:VK_IMAGE_LAYOUT_VIDEO_DECODE_DPB_KHR must: only be used as an
    ...
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR usage flag set.
endif::VK_KHR_video_decode_queue[]
ifdef::VK_KHR_video_encode_queue[]
  ...
  * ename:VK_IMAGE_LAYOUT_VIDEO_ENCODE_SRC_KHR must: only be used as an
    ...
    <<video-encode-operations,video encode operation>>.
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_VIDEO_ENCODE_SRC_BIT_KHR usage flag set.
  * ename:VK_IMAGE_LAYOUT_VIDEO_ENCODE_DPB_KHR must: only be used as an
    ...
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_VIDEO_ENCODE_DPB_BIT_KHR usage flag set.
endif::VK_KHR_video_encode_queue[]
ifdef::VK_EXT_attachment_feedback_loop_layout[]
  * ename:VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT must: only be
    ...
    or input attachment.
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT usage flag
    set, and either the ename:VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT or
    ename:VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT usage flags set, and
    either the ename:VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT or
    ename:VK_IMAGE_USAGE_SAMPLED_BIT usage flags set
endif::VK_EXT_attachment_feedback_loop_layout[]
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
  * ename:VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ must: only be used as either
    a storage image, or a color or depth/stencil attachment and an input
    attachment.
    This layout is valid only for image subresources of images created with
    either the ename:VK_IMAGE_USAGE_STORAGE_BIT usage flag set, or both the
    ename:VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT and either of the
    ename:VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT or
...
ifdef::VK_KHR_video_encode_quantization_map[]
  * ename:VK_IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR must: only be
    used as a <<encode-quantization-map,quantization map>> in a
    <<video-encode-operations,video encode operation>>.
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR or
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR usage flags set.
endif::VK_KHR_video_encode_quantization_map[]
ifdef::VK_ARM_tensors[]
  * ename:VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM specifies the layout that an
    image created with ename:VK_IMAGE_TILING_OPTIMAL must: be in, if the
    <<features-unifiedImageLayouts,pname:unifiedImageLayouts>> feature is
    ...
    tensor/image aliasing.
    This layout is valid only for image subresources of images created with
    the ename:VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM usage flag set.
endif::VK_ARM_tensors[]
...
sname:VkDescriptorImageInfo structure (see <<descriptors-sets-updates>>).

ifdef::VK_KHR_unified_image_layouts[]
If the <<features-unifiedImageLayouts, pname:unifiedImageLayouts>> feature
is enabled, the ename:VK_IMAGE_LAYOUT_GENERAL image layout may: be used in
place of the other layouts where allowed with no loss of performance.
endif::VK_KHR_unified_image_layouts[]

ifdef::VK_KHR_swapchain,VK_KHR_video_encode_queue,VK_KHR_video_decode_queue[]
[NOTE]
====
ename:VK_IMAGE_LAYOUT_GENERAL can be a useful catch-all image layout, but
...
ifdef::VK_KHR_video_decode_queue[]
  * ename:VK_IMAGE_LAYOUT_VIDEO_DECODE_SRC_KHR,
    ename:VK_IMAGE_LAYOUT_VIDEO_DECODE_DST_KHR, and
    ename:VK_IMAGE_LAYOUT_VIDEO_DECODE_DPB_KHR
ifdef::VK_KHR_unified_image_layouts[]
    without the
    <<features-unifiedImageLayoutsVideo,pname:unifiedImageLayoutsVideo>>
    feature
endif::VK_KHR_unified_image_layouts[]
endif::VK_KHR_video_decode_queue[]
ifdef::VK_KHR_video_encode_queue[]
  * ename:VK_IMAGE_LAYOUT_VIDEO_ENCODE_SRC_KHR,
    ename:VK_IMAGE_LAYOUT_VIDEO_ENCODE_DST_KHR, and
    ename:VK_IMAGE_LAYOUT_VIDEO_ENCODE_DPB_KHR
ifdef::VK_KHR_unified_image_layouts[]
    without the
    <<features-unifiedImageLayoutsVideo,pname:unifiedImageLayoutsVideo>>
    feature
...
ifdef::VK_KHR_video_encode_quantization_map[]
  * ename:VK_IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR
ifdef::VK_KHR_unified_image_layouts[]
    without the
    <<features-unifiedImageLayoutsVideo,pname:unifiedImageLayoutsVideo>>
    feature
...
====
endif::VK_KHR_swapchain,VK_KHR_video_encode_queue,VK_KHR_video_decode_queue[]

[NOTE]
====
While ename:VK_IMAGE_LAYOUT_GENERAL suggests that all types of device access
is possible, it does not mean that all patterns of memory accesses are safe
in all situations.
<<common-render-pass-data-races,Common Render Pass Data Races>> outlines
...
image (i.e., not an input attachment), <<renderpass-feedbackloop,enabling
feedback loop>> adds extra guarantees which ename:VK_IMAGE_LAYOUT_GENERAL
alone does not.
endif::VK_EXT_attachment_feedback_loop_layout[]
====
--
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_maintenance2[accesses,]
ifndef::VK_GRAPHICS_VERSION_1_1,VK_KHR_maintenance2[accesses.]
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_maintenance2[]
...
[[resources-external-image-layout-rules]]
=== Image Layout Rules with External Memory

When images created with external memory handle types listed in the
<<resources-external-image-layouts,external image implied layouts table>>
...
[[resources-external-image-layouts]]
.External Image Implied Layouts
[options="header"]
|====
| External Memory Handle Type                                 | Implied Layout When Accessed Externally
ifdef::VK_KHR_external_memory_win32[]
| ename:VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT      | ename:VK_IMAGE_LAYOUT_GENERAL
| ename:VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT  | ename:VK_IMAGE_LAYOUT_GENERAL
endif::VK_KHR_external_memory_win32[]
ifdef::VK_NV_external_memory_win32[]
| ename:VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE_BIT_NV     | ename:VK_IMAGE_LAYOUT_GENERAL
| ename:VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE_KMT_BIT_NV | ename:VK_IMAGE_LAYOUT_GENERAL
...
include::{generated}/api/protos/vkCreateImageView.adoc[]
  ...
  * pname:pCreateInfo is a pointer to a slink:VkImageViewCreateInfo
...
ifdef::VK_KHR_extended_flags[]
  * [[VUID-vkCreateImageView-pNext-12444]]
    The pname:pNext chain of pname:pCreateInfo must: contain at most one of
    the structures slink:VkImageViewUsageCreateInfo and
    slink:VkImageViewUsage2CreateInfoKHR
endif::VK_KHR_extended_flags[]
****
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
If pname:image's format is <<formats-multiplanar, multi-planar>> and
pname:aspectMask is one of ename:VK_IMAGE_ASPECT_PLANE_0_BIT,
ename:VK_IMAGE_ASPECT_PLANE_1_BIT, or ename:VK_IMAGE_ASPECT_PLANE_2_BIT, the
_view format_ is the <<formats-compatible-planes, compatible format for the
plane>>.
Otherwise the
endif::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
ifndef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[The]
_view format_ is the pname:format used to create pname:image.

If pname:image was created with the ename:VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT
flag, pname:format can: be set to a <<formats-compatibility-classes, format
that is compatible>> with the _view format_.
If the image was not created with ename:VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT,
pname:format must: equal the _view format_.

ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
When creating a single-plane view of a <<formats-multiplanar, multi-planar
image>>, pname:width and pname:height must: be derived from the multi-planar
...
If pname:image was created with a <<formats-multiplanar, multi-planar
format>>, and the image view's pname:aspectMask is one of
ename:VK_IMAGE_ASPECT_PLANE_0_BIT, ename:VK_IMAGE_ASPECT_PLANE_1_BIT or
ename:VK_IMAGE_ASPECT_PLANE_2_BIT, the view's aspect mask is considered to
be equivalent to ename:VK_IMAGE_ASPECT_COLOR_BIT when used as a framebuffer
attachment.
endif::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
ifdef::VK_COMPUTE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
any sname:VkImageView used with a combined image sampler that enables
...
ifdef::VK_GRAPHICS_VERSION_1_0,VK_COMPUTE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[and]
storage image descriptors.
endif::VK_COMPUTE_VERSION_1_0[]

ifdef::VK_COMPUTE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
Image views with <<formats-requiring-sampler-ycbcr-conversion, formats that
require YC~B~C~R~ conversion>>
ifdef::VK_ANDROID_external_memory_android_hardware_buffer[]
or <<memory-external-android-hardware-buffer-external-formats, external
formats>>
endif::VK_ANDROID_external_memory_android_hardware_buffer[]
must: be created with a slink:VkSamplerYcbcrConversionInfo structure in the
pname:pNext chain to be used with sampling.
Any image view created with a slink:VkSamplerYcbcrConversionInfo structure
in the pname:pNext chain must: only be sampled using a sampler with an
identically defined slink:VkSamplerYcbcrConversion.
ifdef::VK_KHR_video_queue[]
When used in a <<video-coding,video coding>> operation, the specified
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_maintenance1[, ename:VK_IMAGE_TYPE_3D]
...
ifdef::VK_KHR_video_decode_queue[]
  * [[VUID-VkImageViewCreateInfo-image-08333]]
    If pname:usage contains ename:VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR,
    then the image view's <<resources-image-view-format-features,format
    features>> must: contain
    ename:VK_FORMAT_FEATURE_VIDEO_DECODE_OUTPUT_BIT_KHR
  * [[VUID-VkImageViewCreateInfo-image-08334]]
    If pname:usage contains ename:VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR,
    then the image view's <<resources-image-view-format-features,format
    features>> must: contain
    ename:VK_FORMAT_FEATURE_VIDEO_DECODE_DPB_BIT_KHR
...
ifdef::VK_KHR_video_encode_queue[]
  * [[VUID-VkImageViewCreateInfo-image-08336]]
    If pname:usage contains ename:VK_IMAGE_USAGE_VIDEO_ENCODE_SRC_BIT_KHR,
    then the image view's <<resources-image-view-format-features,format
    features>> must: contain
    ename:VK_FORMAT_FEATURE_VIDEO_ENCODE_INPUT_BIT_KHR
  * [[VUID-VkImageViewCreateInfo-image-08337]]
    If pname:usage contains ename:VK_IMAGE_USAGE_VIDEO_ENCODE_DPB_BIT_KHR,
    then the image view's <<resources-image-view-format-features,format
    features>> must: contain
    ename:VK_FORMAT_FEATURE_VIDEO_ENCODE_DPB_BIT_KHR
...
ifdef::VK_KHR_video_encode_quantization_map[]
  * [[VUID-VkImageViewCreateInfo-usage-10259]]
    ...
    the image view's <<resources-image-view-format-features,format
    features>> must: contain
    ename:VK_FORMAT_FEATURE_2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR
  * [[VUID-VkImageViewCreateInfo-usage-10260]]
    If pname:usage contains
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR, then the image
    view's <<resources-image-view-format-features,format features>> must:
    contain ename:VK_FORMAT_FEATURE_2_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR
endif::VK_KHR_video_encode_quantization_map[]
...
ifdef::VK_EXT_fragment_density_map[]
  * [[VUID-VkImageViewCreateInfo-image-02571]]
    If pname:image was created with the
    ename:VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT usage flag set,
    pname:subresourceRange.levelCount must: be `1`
endif::VK_EXT_fragment_density_map[]
ifndef::VK_BASE_VERSION_1_1,VK_KHR_maintenance1[]
...
ifndef::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
ifndef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
//
// If VK_BASE_VERSION_1_1,VK_KHR_maintenance2 and NOT VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion
ifdef::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
ifndef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
// If NOT VK_BASE_VERSION_1_1,VK_KHR_maintenance2 and VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion
ifndef::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-VkImageViewCreateInfo-image-01760]]
    If pname:image was created with the
    ename:VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT flag, and if the pname:format
    of the pname:image is not a <<formats-multiplanar, multi-planar
    format>>, pname:format must: be compatible with the pname:format used to
    create pname:image, as defined in <<formats-compatibility-classes,Format
    Compatibility Classes>>
endif::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
endif::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
// If VK_BASE_VERSION_1_1,VK_KHR_maintenance2 and VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion
ifdef::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
  * [[VUID-VkImageViewCreateInfo-image-01583]]
    ...
    <<formats-size-compatibility, size-compatible>> with, the pname:format
...
ifdef::VK_BASE_VERSION_1_4,VK_KHR_maintenance6[]
    the
    sname:VkPhysicalDeviceMaintenance6Properties::pname:blockTexelViewCompatibleMultipleLayers
    property is not ename:VK_TRUE,
endif::VK_BASE_VERSION_1_4,VK_KHR_maintenance6[]
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-VkImageViewCreateInfo-image-01586]]
    ...
    the pname:image is a <<formats-multiplanar, multi-planar format>>, and
    if pname:subresourceRange.aspectMask is one of the
    <<formats-multiplanar-image-aspect,multi-planar aspect mask>> bits, then
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-VkImageViewCreateInfo-image-12397]]
    If pname:image was not created with the
    ename:VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT flag pname:format must: be
    identical to the pname:format used to create pname:image
  * [[VUID-VkImageViewCreateInfo-format-12398]]
    If the pname:format of the pname:image is a <<formats-multiplanar,
    multi-planar format>> and pname:subresourceRange.aspectMask is
    ename:VK_IMAGE_ASPECT_COLOR_BIT, pname:format must: be identical to the
    pname:format used to create pname:image
endif::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-VkImageViewCreateInfo-format-06415]]
    If the image view's format <<formats-requiring-sampler-ycbcr-conversion,
...
endif::VK_GRAPHICS_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
ifdef::VK_KHR_fragment_shading_rate,VK_NV_shading_rate_image[]
  * [[VUID-VkImageViewCreateInfo-image-02086]]
    ...
    set, pname:viewType must: be ename:VK_IMAGE_VIEW_TYPE_2D or
    ename:VK_IMAGE_VIEW_TYPE_2D_ARRAY
endif::VK_KHR_fragment_shading_rate,VK_NV_shading_rate_image[]
ifdef::VK_NV_shading_rate_image[]
  * [[VUID-VkImageViewCreateInfo-image-02087]]
    If the <<features-shadingRateImage, pname:shadingRateImage>> feature is
    enabled, and pname:image was created with the
    ename:VK_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV usage flag set,
    pname:format must: be ename:VK_FORMAT_R8_UINT
endif::VK_NV_shading_rate_image[]
ifdef::VK_KHR_fragment_shading_rate[]
  * [[VUID-VkImageViewCreateInfo-attachmentFragmentShadingRate-12386]]
    If the <<features-attachmentFragmentShadingRate,
    pname:attachmentFragmentShadingRate>> feature is not enabled, the
    pname:usage for the image view must: not contain
    ename:VK_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR
  * [[VUID-VkImageViewCreateInfo-usage-04550]]
    If the pname:usage for the image view includes
...
ifdef::VK_EXT_fragment_density_map2[]
  ...
  * [[VUID-VkImageViewCreateInfo-image-03569]]
    ...
    ename:VK_IMAGE_CREATE_SUBSAMPLED_BIT_EXT and the
    ename:VK_IMAGE_USAGE_SAMPLED_BIT usage flag set,
    pname:subresourceRange.layerCount must: be less than or equal to
    <<limits-maxSubsampledArrayLayers,
...
ifdef::VK_HUAWEI_invocation_mask[]
  * [[VUID-VkImageViewCreateInfo-invocationMask-04993]]
    ...
    enabled, and pname:image was created with the
    ename:VK_IMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEI usage flag set,
    pname:format must: be ename:VK_FORMAT_R8_UINT
endif::VK_HUAWEI_invocation_mask[]
  * [[VUID-VkImageViewCreateInfo-flags-04116]]
    ...
    pname:image was created with the
    ename:VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT usage flag set, its
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
ifndef::VK_GRAPHICS_VERSION_1_2,VK_EXT_separate_stencil_usage[]
...
ifdef::VK_KHR_video_decode_queue[]
  * [[VUID-VkImageViewCreateInfo-image-04817]]
    If pname:image was created with the
    ename:VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR usage flag set,
...
ifdef::VK_KHR_video_encode_queue[]
  * [[VUID-VkImageViewCreateInfo-image-04818]]
    If pname:image was created with the
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_DST_BIT_KHR usage flag set,
...
ifdef::VK_KHR_video_encode_quantization_map[]
  * [[VUID-VkImageViewCreateInfo-image-10261]]
    ...
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR or
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR usage flags set,
    then pname:viewType must: be ename:VK_IMAGE_VIEW_TYPE_2D or
    ename:VK_IMAGE_VIEW_TYPE_2D_ARRAY
endif::VK_KHR_video_encode_quantization_map[]
ifdef::VK_EXT_descriptor_buffer[]
...
ifdef::VK_KHR_maintenance11[]
  * [[VUID-VkImageViewCreateInfo-image-13357]]
    If pname:image was created with
    ename:VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR,
    pname:format must: not be a <<formats-multiplanar, multi-planar format>>
endif::VK_KHR_maintenance11[]
ifdef::VK_EXT_ycbcr_2plane_444_formats[]
...
ifdef::VK_KHR_extended_flags[]
[open,refpage='VkImageViewUsage2CreateInfoKHR',desc='Specify the intended usage of an image view',type='structs']
--
The set of usages for the created image view can: be restricted compared to
the parent image's pname:usage flags by adding a
sname:VkImageViewUsage2CreateInfoKHR structure to the pname:pNext chain of
slink:VkImageViewCreateInfo.

The sname:VkImageViewUsage2CreateInfoKHR structure is defined as:

include::{generated}/api/structs/VkImageViewUsage2CreateInfoKHR.adoc[]
...
include::{generated}/validity/structs/VkImageViewUsage2CreateInfoKHR.adoc[]
--
endif::VK_KHR_extended_flags[]
endif::VK_BASE_VERSION_1_1,VK_KHR_maintenance2[]
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
respectively, except if pname:format is a <<formats-multiplanar,
multi-planar format>>.
endif::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
ifdef::VK_KHR_maintenance9[]
If the <<features-maintenance9, pname:maintenance9>> feature is not enabled,
endif::VK_KHR_maintenance9[]
...
enabled in the sampler and the image pname:format is <<formats-multiplanar,
multi-planar format>>, the image must: have been created with
ename:VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT, and the pname:aspectMask of the
sname:VkImageView's pname:subresourceRange must: be
ename:VK_IMAGE_ASPECT_PLANE_0_BIT, ename:VK_IMAGE_ASPECT_PLANE_1_BIT or
ename:VK_IMAGE_ASPECT_PLANE_2_BIT.
endif::VK_COMPUTE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
[[resources-component-mappings-equivalent-to-swizzle_identity-table]]
...
[open,refpage='vkGetImageViewHandle64NVX',desc='Get the 64-bit handle for an image view for a specific descriptor type',type='protos']
--
To get the 64-bit handle for an image view, call:

include::{generated}/api/protos/vkGetImageViewHandle64NVX.adoc[]

  * pname:device is the logical device that owns the image view.
  * pname:pInfo describes the image view to query and type of handle.

include::{generated}/validity/protos/vkGetImageViewHandle64NVX.adoc[]
--
...
****
  ...
  * [[VUID-VkImageViewHandleInfoNVX-imageView-02657]]
    ...
    ename:VK_IMAGE_USAGE_STORAGE_BIT usage flag set
****
...
[open,refpage='vkGetDeviceCombinedImageSamplerIndexNVX',desc='Get the handle for an image view and sampler index',type='protos']
--
To get the handle for a combined image sampler, call:

include::{generated}/api/protos/vkGetDeviceCombinedImageSamplerIndexNVX.adoc[]

  * pname:device is the logical device that will use the result handle.
  * pname:imageViewIndex is the index within the resource heap.
  * pname:samplerIndex is the index within the sampler heap.

Shaders take pname:imageViewIndex and pname:samplerIndex, and multiply it by
slink:VkPhysicalDeviceDescriptorHeapPropertiesEXT::pname:imageDescriptorSize
and
slink:VkPhysicalDeviceDescriptorHeapPropertiesEXT::pname:samplerDescriptorSize
respectively to obtain the descriptor offset in bytes.

include::{generated}/validity/protos/vkGetDeviceCombinedImageSamplerIndexNVX.adoc[]
--
...
ifndef::VK_BASE_VERSION_1_3,VK_KHR_format_feature_flags2[]
...
endif::VK_BASE_VERSION_1_3,VK_KHR_format_feature_flags2[]
ifdef::VK_BASE_VERSION_1_3,VK_KHR_format_feature_flags2[]
  * If Vulkan 1.3 is supported or the `apiext:VK_KHR_format_feature_flags2`
  ...
  ** ename:VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT if the format
     ...
     formats>> and the <<features-shaderStorageImageReadWithoutFormat,
     pname:shaderStorageImageReadWithoutFormat>> feature is enabled.
  ** ename:VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT if the
     ...
     storage formats>> and the
     <<features-shaderStorageImageWriteWithoutFormat,
     pname:shaderStorageImageWriteWithoutFormat>> feature is enabled.
endif::VK_BASE_VERSION_1_3,VK_KHR_format_feature_flags2[]
ifndef::VK_BASE_VERSION_1_3,VK_KHR_format_feature_flags2[]
  * If slink:VkImageViewCreateInfo::pname:image was created with
    ename:VK_IMAGE_TILING_OPTIMAL,
...
Acceleration structures for the `apiext:VK_KHR_acceleration_structure
extension`
ifdef::VK_KHR_opacity_micromap[]
and micromaps for the `apiext:VK_KHR_opacity_micromap extension`
endif::VK_KHR_opacity_micromap[]
are represented by sname:VkAccelerationStructureKHR handles:

include::{generated}/api/handles/VkAccelerationStructureKHR.adoc[]
--

ifdef::VK_KHR_device_address_commands[]
[open,refpage='vkCreateAccelerationStructure2KHR',desc='Create a new acceleration structure object using a device address',type='protos']
--
:refpage: vkCreateAccelerationStructure2KHR

To create an acceleration structure using a device address, call:

include::{generated}/api/protos/vkCreateAccelerationStructure2KHR.adoc[]

  * pname:device is the logical device that creates the acceleration
    structure object.
  * pname:pCreateInfo is a pointer to a
    slink:VkAccelerationStructureCreateInfo2KHR structure containing
...
slink:VkAccelerationStructureCreateInfo2KHR.

The acceleration structure data is stored in the object referred to by
sname:VkAccelerationStructureCreateInfo2KHR::pname:addressRange.address.

Once the sname:VkAccelerationStructureKHR object has been created, it must:
be populated by acceleration structure build or acceleration structure copy
commands such as flink:vkCmdBuildAccelerationStructuresKHR and
...
.Valid Usage
****
include::{chapters}/commonvalidity/create_acceleration_structure_common.adoc[]
  * [[VUID-vkCreateAccelerationStructure2KHR-deviceAddressCommands-13086]]
    The <<features-deviceAddressCommands,
    sname:VkPhysicalDeviceDeviceAddressCommandsFeaturesKHR::pname:deviceAddressCommands>>
    feature must: be enabled
****

include::{generated}/validity/protos/vkCreateAccelerationStructure2KHR.adoc[]
--

[open,refpage='VkAccelerationStructureCreateInfo2KHR',desc='Structure specifying the parameters of a newly created acceleration structure object using a device address',type='structs']
--
:refpage: VkAccelerationStructureCreateInfo2KHR

The sname:VkAccelerationStructureCreateInfo2KHR structure is defined as:

include::{generated}/api/structs/VkAccelerationStructureCreateInfo2KHR.adoc[]
  ...
  * pname:addressRange is a slink:VkDeviceAddressRangeKHR structure defining
    the size required for the acceleration structure and its starting
    address.
  * pname:addressFlags is a tlink:VkAddressCommandFlagsKHR value defining
...
ifdef::VK_KHR_opacity_micromap[ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR,]
...
During replay, if pname:createFlags includes
ename:VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR,
pname:addressRange.address must: be an address used to create an identical
acceleration structure on the same implementation.
The address must: be in the range of an identically created slink:VkBuffer
at the same offset.
...
flink:vkCmdWriteAccelerationStructuresPropertiesKHR can: be used to obtain
...
include::{chapters}/commonvalidity/address_flags_common.adoc[]
  ...
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-addressRange-11602]]
    pname:addressRange.address must: be a valid basetype:VkDeviceAddress
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-addressRange-11603]]
    pname:addressRange must: specify a range within a valid address
    retrieved from pname:buffer that was created with a pname:usage value
    containing ename:VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-addressRange-11604]]
    pname:addressRange must: specify a range within a valid address
    retrieved from pname:buffer that was not created with a pname:flags
    value containing ename:VK_BUFFER_CREATE_SPARSE_RESIDENCY_BIT
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-addressRange-11605]]
    pname:addressRange.address must: be a multiple of `256` bytes
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11606]]
    If the pname:address member of pname:addressRange was retrieved from a
    slink:VkBuffer created with
    ename:VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT,
    pname:createFlags must: include
    ename:VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11607]]
    If the pname:address member of pname:addressRange was retrieved from a
    slink:VkBuffer not created with
    ename:VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT,
    pname:createFlags must: not include
    ename:VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-addressRange-11608]]
    pname:addressRange.size must: be greater than zero
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-micromap-11609]]
    If pname:type is
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR, the
    <<features-micromap,sname:VkPhysicalDeviceOpacityMicromapFeaturesKHR::pname:micromap>>
    feature must: be enabled
ifdef::VK_EXT_descriptor_buffer[]
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11610]]
    If pname:type is
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR,
    pname:createFlags must: not include
    ename:VK_ACCELERATION_STRUCTURE_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT
endif::VK_EXT_descriptor_buffer[]
ifdef::VK_NV_ray_tracing_motion_blur[]
  * [[VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11611]]
    If pname:type is
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR,
    pname:createFlags must: not include
...
include::{chapters}/commonvalidity/create_acceleration_structure_info_common.adoc[]
****

include::{generated}/validity/structs/VkAccelerationStructureCreateInfo2KHR.adoc[]
--
endif::VK_KHR_device_address_commands[]
...
ifdef::VK_KHR_opacity_micromaps[]
Micromaps cannot: be created with this command.
endif::VK_KHR_opacity_micromaps[]
...
include::{generated}/api/structs/VkAccelerationStructureCreateInfoKHR.adoc[]
  ...
  * pname:deviceAddress is the device address requested for the acceleration
    ...
    flink:vkGetAccelerationStructureDeviceAddressKHR, if the
...
ename:VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR or
ename:VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR.
...
****
  ...
  * [[VUID-VkAccelerationStructureCreateInfoKHR-offset-03616]]
    The sum of pname:offset and pname:size must: be less than or equal to
...
Any slink:VkDeviceOrHostAddressKHR, slink:VkDeviceOrHostAddressConstKHR, or
basetype:VkDeviceAddress members of pname:pBuildInfo are ignored by this
command, except that the pname:hostAddress member of
...
ifdef::VK_KHR_opacity_micromap[]
  ** For each element of either pname:pGeometries or pname:ppGeometries at a
     given index, with a pname:geometryType member equal to
     ename:VK_GEOMETRY_TYPE_MICROMAP_KHR, the sum of usage information in
     either the pname:pUsageCounts or pname:ppUsageCounts members of the
     slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
     pname:pNext chain is equal to the sum of usage information in the
     corresponding members of pname:pBuild info.
  ** For each element of either pname:pGeometries or pname:ppGeometries at a
     given index, with a pname:geometryType member equal to
     ename:VK_GEOMETRY_TYPE_TRIANGLES_KHR, if the pname:pNext chain contains
     slink:VkAccelerationStructureTrianglesOpacityMicromapKHR the
     corresponding member of pname:pBuildInfo also contains
     slink:VkAccelerationStructureTrianglesOpacityMicromapKHR and with an
     equivalent pname:micromap.
endif::VK_KHR_opacity_micromap[]
ifdef::VK_AMDX_dense_geometry_format[]
  ** For each element of either pname:pGeometries or pname:ppGeometries at a
     given index, with a pname:geometryType member equal to
     ename:VK_GEOMETRY_TYPE_DENSE_GEOMETRY_FORMAT_TRIANGLES_AMDX, the
     pname:numTriangles member of the
     slink:VkAccelerationStructureDenseGeometryFormatTrianglesDataAMDX
     structure in the pname:pNext chain is less than or equal to the
     corresponding member of the same element in pname:pBuildInfo
  ** For each element of either pname:pGeometries or pname:ppGeometries at a
     given index, with a pname:geometryType member equal to
     ename:VK_GEOMETRY_TYPE_DENSE_GEOMETRY_FORMAT_TRIANGLES_AMDX, the
  ...
  ** For each element of either pname:pGeometries or pname:ppGeometries at a
     ...
     slink:VkAccelerationStructureDenseGeometryFormatTrianglesDataAMDX
     structure in the pname:pNext chain is equal to the corresponding member
     of the same element in pname:pBuildInfo
endif::VK_AMDX_dense_geometry_format[]
...
****
  ...
  * [[VUID-vkGetAccelerationStructureBuildSizesKHR-pMaxPrimitiveCounts-11612]]
    If pname:pBuildInfo->geometryCount is not `0`
ifdef::VK_KHR_opacity_micromap[]
    and pname:pBuildInfo->type is not
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR
endif::VK_KHR_opacity_micromap[]
    , pname:pMaxPrimitiveCounts must: be a valid pointer to an array of
    pname:pBuildInfo->geometryCount code:uint32_t values
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-vkGetAccelerationStructureBuildSizesKHR-pMaxPrimitiveCounts-11613]]
    If pname:pBuildInfo->type is
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR,
    pname:pMaxPrimitiveCounts must: equal `NULL`
  * [[VUID-vkGetAccelerationStructureBuildSizesKHR-buildType-11614]]
    If pname:pBuildInfo->type is
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR,
    pname:buildType must: equal
    ename:VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR
endif::VK_KHR_opacity_micromap[]
...
Implementations must: set pname:updateScratchSize equal to `0` if the
pname:pBuildInfo->type is
ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR.
endif::VK_KHR_opacity_micromap[]
...
[open,refpage='VkAccelerationStructureTypeKHR',desc='Type of acceleration structure',type='enums']
--
...
ifdef::VK_KHR_opacity_micromap[micromap,]
    top, or bottom.
ifdef::VK_KHR_opacity_micromap[]
  * ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR is a micromap
...
ifdef::VK_NV_ray_tracing_motion_blur[]
  * ename:VK_ACCELERATION_STRUCTURE_CREATE_MOTION_BIT_NV specifies that the
    acceleration structure will be used with motion information, see
    slink:VkAccelerationStructureMotionInfoNV for more detail.
endif::VK_NV_ray_tracing_motion_blur[]
--
...
[open,refpage='VkBuildAccelerationStructureFlagBitsKHR',desc='Bitmask specifying additional parameters for acceleration structure builds',type='enums']
--
...
include::{generated}/api/enums/VkBuildAccelerationStructureFlagBitsNV.adoc[]
  ...
  * ename:VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_KHR specifies
...
ifdef::VK_NV_ray_tracing_linear_swept_spheres[]
  ...
  * ename:VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_KHR specifies
  ...
  * ename:VK_BUILD_ACCELERATION_STRUCTURE_LOW_MEMORY_BIT_KHR specifies that
...
ifdef::VK_EXT_opacity_micromap[]
  ...
  * ename:VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DISABLE_OPACITY_MICROMAPS_BIT_KHR
    ...
    in an instance with
    ename:VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR set.
...
ifdef::VK_KHR_opacity_micromap[]
  * ename:VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR specifies
    that micromaps can: be compressed with a lossy encoding as described in
    <<ray-opacity-micromap, Ray Opacity Micromap>>, which may: support
...
[open,refpage='VkBuildAccelerationStructureFlagsKHR',desc='Bitmask of VkBuildAccelerationStructureFlagBitsKHR',type='flags']
--
...
[open,refpage='VkGeometryTypeKHR',desc='Enum specifying which type of geometry is provided',type='enums']
--
...
include::{generated}/api/enums/VkGeometryTypeNV.adoc[]
  ...
  * ename:VK_GEOMETRY_TYPE_TRIANGLES_KHR specifies a geometry type
    consisting of <<ray-tracing-triangle-primitive, triangles>>.
  * ename:VK_GEOMETRY_TYPE_AABBS_KHR specifies a geometry type consisting of
    <<aabb-primitive,axis-aligned bounding boxes>>.
ifdef::VK_KHR_acceleration_structure[]
  * ename:VK_GEOMETRY_TYPE_INSTANCES_KHR specifies a geometry type
    consisting of acceleration structure instances.
endif::VK_KHR_acceleration_structure[]
ifdef::VK_AMDX_dense_geometry_format[]
  * ename:VK_GEOMETRY_TYPE_DENSE_GEOMETRY_FORMAT_TRIANGLES_AMDX specifies a
    geometry type consisting of triangles from compressed data.
endif::VK_AMDX_dense_geometry_format[]
ifdef::VK_NV_ray_tracing_linear_swept_spheres[]
  * ename:VK_GEOMETRY_TYPE_SPHERES_NV specifies a geometry type consisting
    of <<sphere-primitive,spheres>>.
  * ename:VK_GEOMETRY_TYPE_LINEAR_SWEPT_SPHERES_NV specifies a geometry type
    consisting of <<linear-swept-sphere-primitive,linear swept spheres>>.
endif::VK_NV_ray_tracing_linear_swept_spheres[]
ifdef::VK_KHR_opacity_micromap[]
  * VK_GEOMETRY_TYPE_MICROMAP_KHR specifies a geometry type consisting of a
    <<micromap, micromap array>>.
endif::VK_KHR_opacity_micromap[]
--

[open,refpage='VkGeometryFlagBitsKHR',desc='Bitmask specifying additional parameters for a geometry',type='enums']
--
...
include::{generated}/api/enums/VkGeometryFlagBitsNV.adoc[]
  ...
  * ename:VK_GEOMETRY_OPAQUE_BIT_KHR specifies that this geometry does not
    invoke the any-hit shaders even if present in a hit group.
  * ename:VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_KHR specifies that
...
[open,refpage='VkGeometryFlagsKHR',desc='Bitmask of VkGeometryFlagBitsKHR',type='flags']
--
...
flink:vkCreateAccelerationStructure2KHR, the return value will be the same
address as pname:addressRange.address.
endif::VK_KHR_device_address_commands[]

If the acceleration structure was created with
flink:vkCreateAccelerationStructureKHR with a non-zero value of
slink:VkAccelerationStructureCreateInfoKHR::pname:deviceAddress, the return
value will be the same address.

Otherwise, if the acceleration structure was created with a pname:type of
...
flink:vkCreateAccelerationStructureKHR, their device address may: be
...
types other than ename:VK_ACCELERATION_STRUCTURE_TYPE_GENERIC_KHR.
====
...
ifdef::VK_KHR_opacity_micromap[]
Micromaps are represented by slink:VkAccelerationStructureKHR handles for
use with `apiext:VK_KHR_opacity_micromap` commands.
endif::VK_KHR_opacity_micromap[]
...
Micromaps are represented by sname:VkMicromapEXT handles for use with
`apiext:VK_EXT_opacity_micromap` commands:
...
include::{generated}/api/protos/vkCreateMicromapEXT.adoc[]
  ...
  * pname:device is the logical device that creates the micromap structure
    object.
  ...
  * pname:pAllocator controls host memory allocation as described in the
    <<memory-allocation, Memory Allocation>> chapter.
  * pname:pMicromap is a pointer to a slink:VkMicromapEXT handle in which
...
slink:VkCopyMicromapToMemoryInfoEXT::pname:mode to
ename:VK_COPY_MICROMAP_MODE_SERIALIZE_EXT, and during replay the tool will
set slink:VkCopyMemoryToMicromapInfoEXT::pname:mode to
ename:VK_COPY_MICROMAP_MODE_DESERIALIZE_EXT.
====

.Valid Usage
****
  * [[VUID-vkCreateMicromapEXT-micromap-11615]]
    The
    <<features-micromapEXT,sname:VkPhysicalDeviceOpacityMicromapFeaturesEXT::pname:micromap>>
    feature must: be enabled
****
...
include::{generated}/api/structs/VkMicromapCreateInfoEXT.adoc[]
  ...
  * pname:deviceAddress is the device address requested for the micromap if
    the
    <<features-micromapCaptureReplayEXT,sname:VkPhysicalDeviceOpacityMicromapFeaturesEXT::pname:micromapCaptureReplay>>
...
ename:VK_MICROMAP_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT included in
pname:createFlags.
This also means that the tool will need to add
ename:VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT to memory allocations to allow
the ename:VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT flag to be set where the
...
****
  ...
  * [[VUID-VkMicromapCreateInfoEXT-micromapCaptureReplay-11616]]
  ...
  * [[VUID-VkMicromapCreateInfoEXT-bufferDeviceAddressMultiDevice-11617]]
    If pname:createFlags includes
    ename:VK_MICROMAP_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT and
    pname:device was created with multiple physical devices, the
    <<features-bufferDeviceAddressMultiDevice,
    pname:bufferDeviceAddressMultiDevice>> feature must: be enabled
  * [[VUID-VkMicromapCreateInfoEXT-buffer-07435]]
    pname:buffer must: have been created with the
    ename:VK_BUFFER_USAGE_MICROMAP_STORAGE_BIT_EXT usage flag set
...
The pname:dstMicromap, pname:mode, pname:data, pname:scratchData, and
pname:triangleArray members of pname:pBuildInfo are ignored by this command.
...
.Valid Usage
****
  * [[VUID-vkGetMicromapBuildSizesEXT-micromap-11618]]
    The
    <<features-micromapEXT,sname:VkPhysicalDeviceOpacityMicromapFeaturesEXT::pname:micromap>>
    feature must: be enabled
  * [[VUID-vkGetMicromapBuildSizesEXT-device-07440]]
    If pname:device was created with multiple physical devices, the
    <<features-bufferDeviceAddressMultiDevice,
    pname:bufferDeviceAddressMultiDevice>> feature must: be enabled
****
...
.Valid Usage
****
  * [[VUID-vkDestroyMicromapEXT-micromap-11619]]
    The
    <<features-micromapEXT,sname:VkPhysicalDeviceOpacityMicromapFeaturesEXT::pname:micromap>>
    feature must: be enabled
...
ifdef::VK_ARM_tensors[]
[open,refpage='vkGetTensorMemoryRequirementsARM',desc='Returns the memory requirements for specified Vulkan object',type='protos']
--
To determine the memory requirements for a tensor resource, call:

include::{generated}/api/protos/vkGetTensorMemoryRequirementsARM.adoc[]

  * pname:device is the logical device that owns the tensor.
  * pname:pInfo is a pointer to a slink:VkTensorMemoryRequirementsInfoARM
...
include::{generated}/validity/protos/vkGetTensorMemoryRequirementsARM.adoc[]
--

[open,refpage='VkTensorMemoryRequirementsInfoARM',desc='Structure specifying memory requirements',type='structs']
--
The sname:VkTensorMemoryRequirementsInfoARM structure is defined as:

include::{generated}/api/structs/VkTensorMemoryRequirementsInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:tensor is the tensor to query.

include::{generated}/validity/structs/VkTensorMemoryRequirementsInfoARM.adoc[]
--

[open,refpage='vkGetDeviceTensorMemoryRequirementsARM',desc='Returns the memory requirements for specified tensor creation infos',type='protos']
--
To determine the memory requirements for a tensor resource without creating
an object, call:

include::{generated}/api/protos/vkGetDeviceTensorMemoryRequirementsARM.adoc[]

  * pname:device is the logical device intended to own the tensor.
  * pname:pInfo is a pointer to a slink:VkDeviceTensorMemoryRequirementsARM
    structure containing parameters required for the memory requirements
    query.
  * pname:pMemoryRequirements is a pointer to a slink:VkMemoryRequirements2
    structure in which the memory requirements of the tensor object are
...
****
  * [[VUID-vkGetDeviceTensorMemoryRequirementsARM-tensors-09831]]
    The <<features-tensors, pname:tensors>> feature must: be enabled
****

include::{generated}/validity/protos/vkGetDeviceTensorMemoryRequirementsARM.adoc[]
--

[open,refpage='VkDeviceTensorMemoryRequirementsARM',desc='(None)',type='structs']
--
The sname:VkDeviceTensorMemoryRequirementsARM structure is defined as:

include::{generated}/api/structs/VkDeviceTensorMemoryRequirementsARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:pCreateInfo is a pointer to a slink:VkTensorCreateInfoARM
    structure containing parameters affecting the creation of the tensor to
    query.

include::{generated}/validity/structs/VkDeviceTensorMemoryRequirementsARM.adoc[]
--
endif::VK_ARM_tensors[]
...
The value of pname:size has no meaning and should: be ignored if the
...
ifdef::VK_ARM_tensors[]
flink:vkGetDeviceTensorMemoryRequirementsARM,
flink:vkGetTensorMemoryRequirementsARM,
endif::VK_ARM_tensors[]
flink:vkGetBufferMemoryRequirements and flink:vkGetImageMemoryRequirements:
  ...
  * If pname:buffer is a sname:VkBuffer not created with the
    ...
    ename:VK_IMAGE_CREATE_PROTECTED_BIT bit set,
ifdef::VK_ARM_tensors[]
    or if pname:tensor is a sname:VkTensorARM not created with the
    ename:VK_TENSOR_CREATE_PROTECTED_BIT_ARM,
endif::VK_ARM_tensors[]
    then the pname:memoryTypeBits member always contains at least one bit
    set corresponding to a sname:VkMemoryType with a pname:propertyFlags
    that has both the ename:VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT bit and the
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_external_memory[]
  * If pname:buffer was created with
    ...
    slink:VkExternalMemoryImageCreateInfo::pname:handleTypes set to `0`,
ifdef::VK_ARM_tensors[]
    or pname:tensor was created with
    slink:VkExternalMemoryTensorCreateInfoARM::pname:handleTypes set to `0`,
endif::VK_ARM_tensors[]
    the
endif::VK_BASE_VERSION_1_1,VK_KHR_external_memory[]
ifndef::VK_BASE_VERSION_1_1,VK_KHR_external_memory[]
...
ifdef::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
  * If the <<features-maintenance4, pname:maintenance4>> feature is enabled,
    ...
    in the slink:VkImageCreateInfo structure
ifdef::VK_EXT_image_tiling_control[]
    , and the pname:imageTiling member of the
    slink:VkImageTilingControlCreateInfoEXT structure if in the pname:pNext
    chain,
endif::VK_EXT_image_tiling_control[]
    passed to flink:vkCreateImage.
endif::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
...
ifdef::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
    the ename:VK_IMAGE_USAGE_HOST_TRANSFER_BIT bit of the pname:usage member
    if the
    slink:VkPhysicalDeviceHostImageCopyProperties::pname:identicalMemoryTypeRequirements
...
ifdef::VK_ARM_tensors[]
  * If the memory requirements are for a sname:VkTensorARM, the
    pname:memoryTypeBits member must: not refer to a sname:VkMemoryType with
    a pname:propertyFlags that has the
    ename:VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT bit set.
endif::VK_ARM_tensors[]
...
ifdef::VK_ARM_tensors[]
  * The pname:size member is identical for all sname:VkTensorARM objects
    created with the same combination of creation parameters specified in
    sname:VkTensorCreateInfoARM and its pname:pNext chain.
endif::VK_ARM_tensors[]
+
[NOTE]
====
...
ifdef::VK_ARM_tensors[]
  ** The memory requirements returned by
     flink:vkGetDeviceTensorMemoryRequirementsARM are identical to those
     that would be returned by flink:vkGetTensorMemoryRequirementsARM if it
     were called with a sname:VkTensorARM created with the same
     slink:VkTensorCreateInfoARM values, including additional values
     provided via a slink:VkExternalMemoryTensorCreateInfoARM structure.
endif::VK_ARM_tensors[]
endif::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]

ifdef::VK_BASE_VERSION_1_1,VK_KHR_get_memory_requirements2[]
...
ifdef::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
[open,refpage='vkGetDeviceBufferMemoryRequirements',desc='Returns the memory requirements for specified Vulkan object',type='protos']
--
...
ifdef::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
[open,refpage='VkDeviceBufferMemoryRequirements',desc='(None)',type='structs']
--
...
ifdef::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
[open,refpage='vkGetDeviceImageMemoryRequirements',desc='Returns the memory requirements for specified Vulkan object',type='protos']
--
...
ifdef::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
[open,refpage='VkDeviceImageMemoryRequirements',desc='(None)',type='structs']
--
...
ifdef::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
  ...
  * [[VUID-VkDeviceImageMemoryRequirements-pCreateInfo-06419]]
    ...
    valid <<formats-multiplanar-image-aspect,multi-planar aspect mask>> bit
ifdef::VK_EXT_image_drm_format_modifier[]
  ...
  * [[VUID-VkDeviceImageMemoryRequirements-planeAspect-12399]]
    If pname:planeAspect is not 0,
ifdef::VK_EXT_image_drm_format_modifier[]
    pname:pCreateInfo->tiling is not
    ename:VK_IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT,
endif::VK_EXT_image_drm_format_modifier[]
    and pname:pCreateInfo->flags does not have
    ename:VK_IMAGE_CREATE_DISJOINT_BIT set, pname:planeAspect must be a
    valid ename:VkImageAspectFlagBits value
****
...
ifdef::VK_QCOM_tile_memory_heap[]
[open,refpage='VkTileMemoryRequirementsQCOM',desc='Structure specifying tile memory requirements',type='structs']
--
To determine the tile memory allocation requirements of a buffer or image
resource, add a sname:VkTileMemoryRequirementsQCOM structure to the
...
The sname:VkTileMemoryRequirementsQCOM structure is defined as:

include::{generated}/api/structs/VkTileMemoryRequirementsQCOM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:size is the size, in bytes, of the tile memory allocation required
    for the resource.
  * pname:alignment is the alignment, in bytes, of the offset within the
    tile memory allocation required for the resource.

The pname:size and pname:alignment must: be used when the resource is bound
to a slink:VkDeviceMemory object that was allocated from a
slink:VkMemoryType that has a pname:heapIndex that corresponds to a
slink:VkMemoryHeap with the ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM
property.

If the resource cannot be bound to tile memory, then pname:size and
pname:alignment is filled with zero by the implementation.

include::{generated}/validity/structs/VkTileMemoryRequirementsQCOM.adoc[]
--
endif::VK_QCOM_tile_memory_heap[]
...
--
endif::VK_BASE_VERSION_1_1,VK_KHR_get_memory_requirements2[]
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_external_memory,VK_EXT_image_drm_format_modifier[]
    otherwise
endif::VK_BASE_VERSION_1_1,VK_KHR_external_memory,VK_EXT_image_drm_format_modifier[]
    be ename:VK_FALSE
...
Constraints on the values returned for tensor resources are:
  ...
  * pname:requiresDedicatedAllocation may: be ename:VK_TRUE if the
    pname:pNext chain of slink:VkTensorCreateInfoARM for the call to
    fname:vkCreateTensorARM used to create the tensor being queried included
    a slink:VkExternalMemoryTensorCreateInfoARM structure, and any of the
    handle types specified in
    slink:VkExternalMemoryTensorCreateInfoARM::pname:handleTypes requires
    dedicated allocation, as reported by
    flink:vkGetPhysicalDeviceExternalTensorPropertiesARM in
    sname:VkExternalTensorPropertiesARM::pname:externalMemoryProperties.externalMemoryFeatures.
ifdef::VK_ARM_tensor_controls[]
  * pname:requiresDedicatedAllocation will be ename:VK_TRUE if the
    slink:VkTensorDescriptionARM::pname:tiling provided via the
    slink:VkTensorCreateInfoARM structure for the call to
    flink:vkCreateTensorARM used to create the tensor being queried was
...
ifdef::VK_BASE_VERSION_1_4,VK_KHR_maintenance6[]
slink:VkBindMemoryStatus structures were not included in the pname:pNext
...
ifdef::VK_BASE_VERSION_1_4,VK_KHR_maintenance6[]
[open,refpage='VkBindMemoryStatus',desc='Structure specifying where to return memory binding status',type='structs']
--
The sname:VkBindMemoryStatus structure is defined as:

include::{generated}/api/structs/VkBindMemoryStatus.adoc[]
...
slink:VkBindImageMemoryInfo includes a sname:VkBindMemoryStatus structure,
then the sname:VkBindMemoryStatus::pname:pResult will be populated with a
value describing the result of the corresponding memory binding operation.

include::{generated}/validity/structs/VkBindMemoryStatus.adoc[]
--
endif::VK_BASE_VERSION_1_4,VK_KHR_maintenance6[]
endif::VK_BASE_VERSION_1_1,VK_KHR_bind_memory2[]
...
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-vkBindImageMemory-memory-10736]]
    ...
    a call to fname:vkGetImageMemoryRequirements2 with pname:image
endif::VK_QCOM_tile_memory_heap[]
...
ifdef::VK_QCOM_tile_memory_heap[]
    ...
    from a call to fname:vkGetImageMemoryRequirements with pname:image must:
    be less than or equal to the size of pname:memory minus
    pname:memoryOffset
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-vkBindImageMemory-memory-10738]]
    ...
    member of the sname:VkTileMemoryRequirementsQCOM structure returned from
    a call to fname:vkGetImageMemoryRequirements2 with pname:image must: be
...
ifdef::VK_QCOM_tile_memory_heap[]
    and pname:memory was not allocated from a memory heap with the
    ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM property set,
endif::VK_QCOM_tile_memory_heap[]
    then pname:memory must: have been allocated using one of the memory
    types allowed in the pname:memoryTypeBits member of the
    slink:VkMemoryRequirements structure returned from a call to
...
ifdef::VK_QCOM_tile_memory_heap[]
    ...
    then pname:memoryOffset must: be an integer multiple of the
...
ifdef::VK_QCOM_tile_memory_heap[]
    ...
    then the difference of the size of pname:memory and pname:memoryOffset
    must: be greater than or equal to the pname:size member of the
    slink:VkMemoryRequirements structure returned from a call to
    flink:vkGetImageMemoryRequirements2 with the same pname:image
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkBindImageMemoryInfo-pNext-12329]]
    If the pname:pNext chain does not include a
    slink:VkBindImagePlaneMemoryInfo structure, and pname:memory was
    allocated from a memory heap with the
    ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM property set, then
    pname:memoryOffset must: be an integer multiple of the pname:alignment
    member of the sname:VkTileMemoryRequirementsQCOM structure returned from
    a call to fname:vkGetImageMemoryRequirements2 with pname:image
  * [[VUID-VkBindImageMemoryInfo-pNext-12330]]
    If the pname:pNext chain does not include a
    slink:VkBindImagePlaneMemoryInfo structure, and pname:memory was
    allocated from a memory heap with the
    ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM property set, then pname:size
    member of the sname:VkTileMemoryRequirementsQCOM structure returned from
    a call to fname:vkGetImageMemoryRequirements2 with pname:image must: be
    less than or equal to the size of pname:memory minus pname:memoryOffset
endif::VK_QCOM_tile_memory_heap[]
...
ifndef::VK_BASE_VERSION_1_1+VK_KHR_swapchain[]
...
endif::VK_BASE_VERSION_1_1+VK_KHR_swapchain[]
ifdef::VK_BASE_VERSION_1_1,VK_KHR_device_group[]
...
ifndef::VK_BASE_VERSION_1_1,VK_KHR_device_group[]
...
ifdef::VK_ARM_tensors[]
[open,refpage='vkBindTensorMemoryARM',desc='Bind device memory to tensor objects',type='protos']
--
To attach memory to tensor objects call:

include::{generated}/api/protos/vkBindTensorMemoryARM.adoc[]

  * pname:device is the logical device that owns the buffers and memory.
  * pname:bindInfoCount is the number of elements in pname:pBindInfos.
  * pname:pBindInfos is a pointer to an array of structures of type
    slink:VkBindTensorMemoryInfoARM, describing tensors and memory to bind.

On some implementations, it may: be more efficient to batch memory bindings
into a single command.

include::{generated}/validity/protos/vkBindTensorMemoryARM.adoc[]
--

[open,refpage='VkBindTensorMemoryInfoARM',desc='Structure specifying how to bind a tensor to memory',type='structs']
--
The sname:VkBindTensorMemoryInfoARM structure is defined as:

include::{generated}/api/structs/VkBindTensorMemoryInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:tensor is the tensor to be attached to memory.
  * pname:memory is a slink:VkDeviceMemory object describing the device
    memory to attach.
  * pname:memoryOffset is the start offset of the region of pname:memory
    ...
    The number of bytes returned in the
    sname:VkMemoryRequirements::pname:size member in pname:memory, starting
    from pname:memoryOffset bytes, will be bound to the specified tensor.

.Valid Usage
****
  * [[VUID-VkBindTensorMemoryInfoARM-tensor-09712]]
    pname:tensor must: not already be backed by a memory object
  ...
  * [[VUID-VkBindTensorMemoryInfoARM-memory-09714]]
    ...
    allowed in the pname:memoryTypeBits member of the
    sname:VkMemoryRequirements structure returned from a call to
    fname:vkGetTensorMemoryRequirementsARM with pname:tensor
  * [[VUID-VkBindTensorMemoryInfoARM-memoryOffset-09715]]
    pname:memoryOffset must: be an integer multiple of the pname:alignment
    member of the sname:VkMemoryRequirements structure returned from a call
    to fname:vkGetTensorMemoryRequirementsARM with pname:tensor
  * [[VUID-VkBindTensorMemoryInfoARM-size-09716]]
    The pname:size member of the sname:VkMemoryRequirements structure
    returned from a call to fname:vkGetTensorMemoryRequirementsARM with
    pname:tensor must: be less than or equal to the size of pname:memory
    minus pname:memoryOffset
  * [[VUID-VkBindTensorMemoryInfoARM-tensor-09717]]
    If pname:tensor requires a dedicated allocation (as reported by
    flink:vkGetTensorMemoryRequirementsARM in
    slink:VkMemoryDedicatedRequirements::pname:requiresDedicatedAllocation
    for pname:tensor), pname:memory must: have been created with
    slink:VkMemoryDedicatedAllocateInfoTensorARM::pname:tensor equal to
    pname:tensor
  * [[VUID-VkBindTensorMemoryInfoARM-memory-09806]]
    If the slink:VkMemoryAllocateInfo provided when pname:memory was
    allocated included a slink:VkMemoryDedicatedAllocateInfoTensorARM
    structure in its pname:pNext chain, and
    slink:VkMemoryDedicatedAllocateInfoTensorARM::pname:tensor was not
    dlink:VK_NULL_HANDLE, then pname:tensor must: equal
    slink:VkMemoryDedicatedAllocateInfoTensorARM::pname:tensor, and
  ...
  * [[VUID-VkBindTensorMemoryInfoARM-memory-09895]]
    ...
    the handles set in
    slink:VkExternalMemoryTensorCreateInfoARM::pname:handleTypes when
    pname:tensor was created
...
ifdef::VK_ANDROID_external_memory_android_hardware_buffer[]
    ...
    in slink:VkExternalMemoryTensorCreateInfoARM::pname:handleTypes when
    pname:tensor was created
ifdef::VK_ANDROID_external_memory_android_hardware_buffer[]
  ...
  * [[VUID-VkBindTensorMemoryInfoARM-tensor-09718]]
    If pname:tensor was created with the
    ename:VK_TENSOR_CREATE_PROTECTED_BIT_ARM bit set, the tensor must: be
  ...
  * [[VUID-VkBindTensorMemoryInfoARM-tensor-09719]]
    If pname:tensor was created with the
    ename:VK_TENSOR_CREATE_PROTECTED_BIT_ARM bit not set, the tensor must:
    not be bound to a memory object allocated with a memory type that
    reports ename:VK_MEMORY_PROPERTY_PROTECTED_BIT
ifdef::VK_EXT_descriptor_buffer[]
  * [[VUID-VkBindTensorMemoryInfoARM-tensor-09943]]
    If pname:tensor was created with the
    ename:VK_TENSOR_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM bit set,
...
ifdef::VK_EXT_descriptor_heap[]
  * [[VUID-VkBindTensorMemoryInfoARM-tensor-11406]]
    If pname:tensor was created with the
    ename:VK_TENSOR_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_ARM bit set,
    pname:memory must: have been allocated with the
    ename:VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT bit set
...
include::{generated}/validity/structs/VkBindTensorMemoryInfoARM.adoc[]
--
endif::VK_ARM_tensors[]
...
ifdef::VK_ARM_tensors[]
The limit pname:bufferImageGranularity also applies to tensor resources.
endif::VK_ARM_tensors[]
====
...
family,
ifdef::VK_KHR_maintenance9[]
unless the <<features-maintenance9, pname:maintenance9>> feature is enabled,
endif::VK_KHR_maintenance9[]
the application must: perform a <<synchronization-queue-transfers,queue
...
ename:VK_SHARING_MODE_EXCLUSIVE resources that are already owned by a queue
...
ifdef::VK_KHR_maintenance9[]
If the <<features-maintenance9, pname:maintenance9>> feature is enabled, the
contents of buffer resources, and of linear image resources (i.e., those
created with pname:tiling set to ename:VK_IMAGE_TILING_LINEAR) are always
...
ename:VK_QUEUE_FAMILY_FOREIGN_EXT or
endif::VK_EXT_queue_family_foreign[]
ename:VK_QUEUE_FAMILY_EXTERNAL).
This means that whenever the <<features-maintenance9, pname:maintenance9>>
...
Additionally, if the <<features-maintenance9, pname:maintenance9>> feature
is enabled, the contents of some optimal image resources (i.e., those
created with ename:VK_IMAGE_TILING_OPTIMAL) are always preserved when they
...
slink:VkQueueFamilyOwnershipTransferPropertiesKHR::pname:optimalImageTransferToQueueFamilies,
and that were created without any of the following bits set in pname:usage:
...
<<resources-image-layouts, layout transition>> from these layouts:
...
or buffer range of a resource created with ename:VK_SHARING_MODE_EXCLUSIVE,
...
[NOTE]
====
The implementation-dependent limit pname:bufferImageGranularity also applies
to tensor resources.
====
...
and linear image subresources are considered _host-accessible subresources_
...
met:
  ...
  * The buffer referred to by the pname:buffer member of the
    slink:VkAccelerationStructureCreateInfoKHR that `AS_2` was created with
    must: be bound to the same slink:VkDeviceMemory as the buffer referred
    to by the pname:buffer member of the
    slink:VkAccelerationStructureCreateInfoKHR that `AS_1` was created with.
  * The start of the memory range occupied by `AS_2`, defined by the sum of
    the pname:offset member of the
    slink:VkAccelerationStructureCreateInfoKHR that `AS_2` was created with
    and the offset at which the buffer associated with `AS_2` is bound to a
    slink:VkDeviceMemory, must: match the start of the memory range occupied
    by `AS_1`.
  * If the pname:deviceAddress member of the
    slink:VkAccelerationStructureCreateInfoKHR that `AS_2` was created with
    is non-zero, it must: match the pname:deviceAddress member of the
    slink:VkAccelerationStructureCreateInfoKHR that `AS_1` was created with.
  * The pname:createFlags member of the
    slink:VkAccelerationStructureCreateInfoKHR that `AS_2` was created with
    must: match the pname:createFlags member of the
    slink:VkAccelerationStructureCreateInfoKHR that `AS_1` was created with.
  * The pname:type member of the slink:VkAccelerationStructureCreateInfoKHR
    that `AS_2` was created with must: match the pname:type member of the
    slink:VkAccelerationStructureCreateInfoKHR that `AS_1` was created with.
  * The pname:size member of the slink:VkAccelerationStructureCreateInfoKHR
    that `AS_2` was created with must: be greater or equal to the pname:size
    returned by flink:vkGetAccelerationStructureBuildSizesKHR for the build
...
only if:
  ...
  * The image was created with ename:VK_IMAGE_TILING_LINEAR and the tensor
    was created with ename:VK_TENSOR_TILING_LINEAR_ARM.
    The strides for the image subresource, as reported by
    flink:vkGetImageSubresourceLayout, are compatible with strides passed
    when creating the tensor, i.e.
    slink:VkTensorDescriptionARM::pname:pStrides[pname:dimensionCount-3]
    must be equal to slink:VkSubresourceLayout::pname:rowPitch if
    slink:VkTensorDescriptionARM::pname:dimensionCount is greater than 2 and
    slink:VkTensorDescriptionARM::pname:pStrides[pname:dimensionCount-4]
    must be equal to slink:VkSubresourceLayout::pname:depthPitch if
    slink:VkTensorDescriptionARM::pname:dimensionCount is greater than 3.
  * The image was created with ename:VK_IMAGE_TILING_OPTIMAL and the tensor
    was created with ename:VK_TENSOR_TILING_OPTIMAL_ARM.
    The image was created with the
    ename:VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM usage flag set and the
    tensor was created with ename:VK_TENSOR_USAGE_IMAGE_ALIASING_BIT_ARM.
  * The format of the tensor must be compatible with that of the individual
    components of the format of the image.
  * The number of dimensions of the tensor
    (slink:VkTensorDescriptionARM::pname:dimensionCount) is greater than or
    equal to the number of dimensions of the image (as specified by
    slink:VkImageCreateInfo::pname:imageType) plus 1.
  * The size of the tensor along its innermost dimension
    (slink:VkTensorDescriptionARM::pname:pDimensions[pname:dimensionCount-1])
  ...
  * The image subresource is in the
    ename:VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM layout if the image was
    created with ename:VK_IMAGE_TILING_OPTIMAL
ifdef::VK_KHR_unified_image_layouts[]
    and the <<features-unifiedImageLayouts,pname:unifiedImageLayouts>>
    feature is not enabled.
    If the <<features-unifiedImageLayouts,pname:unifiedImageLayouts>>
...
ifndef::VK_KHR_unified_image_layouts[]
    ...
    ename:VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM prior to any reads via the
...
ifndef::VK_KHR_unified_image_layouts[]
    ...
    ename:VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM prior to any writes performed
...
from ename:VK_IMAGE_LAYOUT_UNDEFINED to a valid layout before it is used,
ifdef::VK_EXT_zero_initialize_device_memory[]
from ename:VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT if it is zeroed,
endif::VK_EXT_zero_initialize_device_memory[]
or from ename:VK_IMAGE_LAYOUT_PREINITIALIZED if the memory has been written
by the host.
...
to not overlap, as defined in <<memory-model-memory-location,Memory
Location>>, and the operation, resource, and access are otherwise
independently valid.

Some operations have alignment requirements or access ambiguous
<<memory-model-memory-location,memory locations>>, so the semantics of a
...
aligned to <<limits-nonCoherentAtomSize,pname:nonCoherentAtomSize>>, as
defined by flink:vkFlushMappedMemoryRanges and
flink:vkInvalidateMappedMemoryRanges.
...
include::{generated}/api/protos/vkCreateBufferCollectionFUCHSIA.adoc[]
  ...
  * pname:pAllocator is a pointer to a slink:VkAllocationCallbacks structure
    ...
    <<memory-allocation, Memory Allocation>> chapter
  * pname:pCollection is a pointer to a slink:VkBufferCollectionFUCHSIA
...
include::{generated}/api/structs/VkBufferConstraintsInfoFUCHSIA.adoc[]
  ...
  * pname:requiredFormatFeatures is a bitmask of
    ename:VkFormatFeatureFlagBits required features of the buffers in the
    buffer collection
...
[open,refpage='VkTensorARM',desc='Opaque handle to a tensor object',type='handles']
--
Tensors are similar to <<images,images>>, in that they have
multi-dimensional access as documented in the <<tensors>> chapter, but a
tensor's dimensions are not predefined.
A tensor can have an arbitrary number of dimensions, up to
<<limits-maxTensorDimensionCount,pname:maxTensorDimensionCount>>, with one
...
Tensors are represented by sname:VkTensorARM handles:

include::{generated}/api/handles/VkTensorARM.adoc[]
--

[open,refpage='vkCreateTensorARM',desc='Create a new tensor object',type='protos']
--
To create tensors, call:

include::{generated}/api/protos/vkCreateTensorARM.adoc[]

  * pname:device is the logical device that creates the tensor.
  * pname:pCreateInfo is a pointer to a slink:VkTensorCreateInfoARM
    structure containing parameters to be used to create the tensor.
  * pname:pAllocator controls host memory allocation as described in the
    <<memory-allocation, Memory Allocation>> chapter.
  * pname:pTensor is a pointer to a slink:VkTensorARM handle in which the
...
include::{generated}/validity/protos/vkCreateTensorARM.adoc[]
--

[open,refpage='VkTensorCreateInfoARM',desc='Structure specifying the parameters of a newly created tensor object',type='structs']
--
The slink:VkTensorCreateInfoARM structure is defined as:

include::{generated}/api/structs/VkTensorCreateInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:flags is a bitmask of elink:VkTensorCreateFlagBitsARM describing
    additional parameters of the tensor.
  * pname:pDescription is a pointer to an instance of
    slink:VkTensorDescriptionARM describing the tensor.
  * pname:sharingMode is a elink:VkSharingMode value specifying the sharing
  ...
  * pname:pQueueFamilyIndices is a list of queue families that will access
    this tensor (ignored if pname:sharingMode is not
    ename:VK_SHARING_MODE_CONCURRENT).

To determine the set of valid pname:usage bits for a given tensor format,
call flink:vkGetPhysicalDeviceFormatProperties2 with
slink:VkTensorFormatPropertiesARM in the pname:pNext chain.

[[resources-tensor-creation-limits]]
...
The limiting values are referenced by the relevant valid usage statements of
sname:VkTensorCreateInfoARM.

  * Let the [eq]#uint64_t tensorElements# define the number of data elements
    in the tensor computed as the product of all
    sname:VkTensorCreateInfoARM::pname:pDescription->pDimensions[i] for i
    between 0 and
    sname:VkTensorCreateInfoARM::pname:pDescription->dimensionCount - 1.
****

.Valid Usage
****
  * [[VUID-VkTensorCreateInfoARM-pDescription-09720]]
    If pname:pDescription->tiling is ename:VK_TENSOR_TILING_OPTIMAL_ARM,
    pname:pDescription->pStrides must: be `NULL`
  * [[VUID-VkTensorCreateInfoARM-tensorElements-09721]]
    pname:tensorElements (as defined in
    <<resources-tensor-creation-limits>>) must: not be greater than
    slink:VkPhysicalDeviceTensorPropertiesARM::pname:maxTensorElements
  * [[VUID-VkTensorCreateInfoARM-sharingMode-09722]]
    If pname:sharingMode is ename:VK_SHARING_MODE_CONCURRENT,
    pname:pQueueFamilyIndices must: be a valid pointer to an array of
    pname:queueFamilyIndexCount code:uint32_t values
ifdef::VK_KHR_maintenance11[]
  * [[VUID-VkTensorCreateInfoARM-maintenance11-13358]]
    If the <<features-maintenance11,pname:maintenance11>> feature is enabled
    and pname:sharingMode is ename:VK_SHARING_MODE_CONCURRENT, then
    pname:queueFamilyIndexCount must: be greater than `0`
endif::VK_KHR_maintenance11[]
...
ifdef::VK_KHR_maintenance11[]
  ...
  * [[VUID-VkTensorCreateInfoARM-pNext-09864]]
    If the pname:pNext chain includes a
    slink:VkExternalMemoryTensorCreateInfoARM structure, its
    pname:handleTypes member must: only contain bits that are also in
    slink:VkExternalTensorPropertiesARM::pname:externalMemoryProperties.compatibleHandleTypes,
    as returned by flink:vkGetPhysicalDeviceExternalTensorPropertiesARM with
    pname:pExternalTensorInfo->handleType equal to any one of the handle
    types specified in
    slink:VkExternalMemoryTensorCreateInfoARM::pname:handleTypes
ifdef::VK_EXT_descriptor_buffer[]
  * [[VUID-VkTensorCreateInfoARM-flags-09726]]
    If pname:flags includes
    ename:VK_TENSOR_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM, the
    <<features-descriptorBufferCaptureReplay,pname:descriptorBufferCaptureReplay>>
    feature must: be enabled
  * [[VUID-VkTensorCreateInfoARM-pNext-09727]]
    If the pname:pNext chain includes a
    slink:VkOpaqueCaptureDescriptorDataCreateInfoEXT structure, pname:flags
    must: contain
    ename:VK_TENSOR_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM
endif::VK_EXT_descriptor_buffer[]
  * [[VUID-VkTensorCreateInfoARM-pDescription-09728]]
    If pname:pDescription->usage does not have any of the following bits set
    (i.e. if it is not possible to create a tensor view for this tensor),
    then the <<resources-tensor-view-format-features,format features>> must:
    contain the format feature flags required by the pname:usage flags for
    pname:pDescription->format as indicated in the
    <<format-feature-dependent-usage-flags>> section
  ** ename:VK_TENSOR_USAGE_SHADER_BIT_ARM
ifdef::VK_ARM_data_graph[]
  ** ename:VK_TENSOR_USAGE_DATA_GRAPH_BIT_ARM
endif::VK_ARM_data_graph[]
...
ifdef::VK_EXT_descriptor_heap[]
  * [[VUID-VkTensorCreateInfoARM-flags-11395]]
    If slink:VkOpaqueCaptureDataCreateInfoEXT::pname:pData is not `NULL`,
    pname:flags must: contain
    ename:VK_TENSOR_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_ARM
...
ifdef::VK_ARM_tensor_controls[]
  * [[VUID-VkTensorCreateInfoARM-pNext-09833]]
    If a slink:VkTensorRollingBackingCreateInfoARM structure is present in
    the pname:pNext chain of slink:VkTensorCreateInfoARM, then
    pname:pDescription->tiling must: be ename:VK_TENSOR_TILING_LINEAR_ARM,
    ename:VK_TENSOR_TILING_BRICK_16_WIDE_ARM,
    ename:VK_TENSOR_TILING_BRICK_8_WIDE_ARM, or
    ename:VK_TENSOR_TILING_BRICK_4_WIDE_ARM
  * [[VUID-VkTensorCreateInfoARM-pNext-09834]]
    If a slink:VkTensorRollingBackingCreateInfoARM structure is present in
    the pname:pNext chain of slink:VkTensorCreateInfoARM, then
    pname:pDescription->dimensionCount must: be less than or equal to `4`
endif::VK_ARM_tensor_controls[]
****

include::{generated}/validity/structs/VkTensorCreateInfoARM.adoc[]
--

[open,refpage='VkTensorCreateFlagBitsARM',desc='Bitmask specifying additional parameters of a tensor',type='enums']
--
Bits which can: be set in slink:VkTensorCreateInfoARM::pname:flags,
specifying additional parameters of a tensor, are:

include::{generated}/api/enums/VkTensorCreateFlagBitsARM.adoc[]

  * ename:VK_TENSOR_CREATE_MUTABLE_FORMAT_BIT_ARM specifies that the tensor
    can: be used to create a sname:VkTensorViewARM with a different format
    from the tensor.
  * ename:VK_TENSOR_CREATE_PROTECTED_BIT_ARM specifies that the tensor is a
    protected tensor.
ifdef::VK_EXT_descriptor_buffer[]
  * ename:VK_TENSOR_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM
...
[open,refpage='VkTensorCreateFlagsARM',desc='Bitmask of VkTensorCreateFlagBitsARM',type='flags']
--
include::{generated}/api/flags/VkTensorCreateFlagsARM.adoc[]

tname:VkTensorCreateFlagsARM is a bitmask type for setting a mask of zero or
more elink:VkTensorCreateFlagBitsARM.
--

[open,refpage='VkExternalMemoryTensorCreateInfoARM',desc='Specify that a tensor may be backed by external memory',type='structs']
--
To define a set of external memory handle types that may: be used as backing
store for a tensor, add a slink:VkExternalMemoryTensorCreateInfoARM
structure to the pname:pNext chain of the slink:VkTensorCreateInfoARM
structure.

The sname:VkExternalMemoryTensorCreateInfoARM structure is defined as:

include::{generated}/api/structs/VkExternalMemoryTensorCreateInfoARM.adoc[]

[NOTE]
====
A sname:VkExternalMemoryTensorCreateInfoARM structure with a non-zero
pname:handleTypes field must be included in the creation parameters for a
...
include::{generated}/validity/structs/VkExternalMemoryTensorCreateInfoARM.adoc[]
--

ifdef::VK_ARM_tensor_controls[]
[open,refpage='VkTensorRollingBackingCreateInfoARM',desc='Structure specifying the parameters of a newly created tensor object with rolling backing',type='structs']
--

To create a tensor for which only a rolling window is backed by memory, add
a slink:VkTensorRollingBackingCreateInfoARM structure to the pname:pNext
chain of the slink:VkTensorCreateInfoARM structure.

The slink:VkTensorRollingBackingCreateInfoARM structure is defined as:

include::{generated}/api/structs/VkTensorRollingBackingCreateInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:wraps is an array of
    ename:VK_MAX_TENSOR_CREATE_INFO_ROLLING_BACKING_WRAP_COUNT_ARM 32-bit
...
slink:VkTensorRollingBackingCreateInfoARM, these latter values are defined
once in this inset.

  * Let [eq]#uint32_t pname:brickOuterSize# define the size of a brick along
    its outermost dimension.
  ** If slink:VkTensorDescriptionARM::pname:tiling is
     ename:VK_TENSOR_TILING_BRICK_16_WIDE_ARM, then
     [eq]#pname:brickOuterSize = 16#.
  ** If slink:VkTensorDescriptionARM::pname:tiling is
     ename:VK_TENSOR_TILING_BRICK_8_WIDE_ARM, then [eq]#pname:brickOuterSize
     = 8#.
  ** If slink:VkTensorDescriptionARM::pname:tiling is
     ename:VK_TENSOR_TILING_BRICK_4_WIDE_ARM, then [eq]#pname:brickOuterSize
     = 4#.
  ** Otherwise, [eq]#pname:brickOuterSize = 1#.
  * Let [eq]#uint32_t pname:elementSize# define the size of individual
...
****
  * [[VUID-VkTensorRollingBackingCreateInfoARM-wraps-09835]]
    For each [eq]#i# where [eq]#i <
    slink:VkTensorDescriptionARM::pname:dimensionCount#,
    [eq]#pname:wraps[i]# must: be less than or equal to
    slink:VkTensorDescriptionARM::pname:pDimensions[i]
  * [[VUID-VkTensorRollingBackingCreateInfoARM-wraps-09836]]
    For each [eq]#i# where [eq]#i <
    slink:VkTensorDescriptionARM::pname:dimensionCount#,
    [eq]#pname:wraps[i]# must: either be equal to
    slink:VkTensorDescriptionARM::pname:pDimensions[i] or must: be less than
    [eq]#2^16#
  * [[VUID-VkTensorRollingBackingCreateInfoARM-wraps-09837]]
    For each [eq]#i# where [eq]#i <
    slink:VkTensorDescriptionARM::pname:dimensionCount#, if
    [eq]#pname:wraps[i]# is not equal to
    slink:VkTensorDescriptionARM::pname:pDimensions[i] and one element
    pname:wraps[j] with [eq]#j < i# is not a power of two, then
    pname:wraps[i] must: be a power of two
  * [[VUID-VkTensorRollingBackingCreateInfoARM-wraps-09838]]
    If slink:VkTensorDescriptionARM::pname:dimensionCount is greater than 1,
    then pname:wraps[pname:dimensionCount - 2] must: be a multiple of
    pname:brickOuterSize or must: be equal to
    slink:VkTensorDescriptionARM::pname:pDimensions[pname:dimensionCount -
    2]
  * [[VUID-VkTensorRollingBackingCreateInfoARM-wraps-09839]]
    If pname:brickOuterSize is not equal to 1, then
    pname:wraps[pname:dimensionCount - 1] must: be a multiple of [eq]#64 /
    pname:brickOuterSize / pname:elementSize# or be equal to
    slink:VkTensorDescriptionARM::pname:pDimensions[pname:dimensionCount -
    1]
****

include::{generated}/validity/structs/VkTensorRollingBackingCreateInfoARM.adoc[]
--

[open,refpage='VK_MAX_TENSOR_CREATE_INFO_ROLLING_BACKING_WRAP_COUNT_ARM',desc='Maximum number of tensor rolling backing wraps',type='consts']
--
ename:VK_MAX_TENSOR_CREATE_INFO_ROLLING_BACKING_WRAP_COUNT_ARM is the
maximum number of tensor rolling backing wraps.

include::{generated}/api/enums/VK_MAX_TENSOR_CREATE_INFO_ROLLING_BACKING_WRAP_COUNT_ARM.adoc[]
--

endif::VK_ARM_tensor_controls[]

[open,refpage='vkDestroyTensorARM',desc='Destroy a tensor object',type='protos']
--
To destroy a tensor, call:

include::{generated}/api/protos/vkDestroyTensorARM.adoc[]

  * pname:device is the logical device that destroys the tensor.
  * pname:tensor is the tensor to destroy.
  * pname:pAllocator controls host memory allocation as described in the
    <<memory-allocation, Memory Allocation>> chapter.
...
****
  * [[VUID-vkDestroyTensorARM-tensor-09730]]
    All submitted commands that refer to pname:tensor, either directly or
    via a sname:VkTensorViewARM, must: have completed execution
  * [[VUID-vkDestroyTensorARM-tensor-09731]]
    If sname:VkAllocationCallbacks were provided when pname:tensor was
    created, a compatible set of callbacks must: be provided here
  * [[VUID-vkDestroyTensorARM-tensor-09732]]
    If no sname:VkAllocationCallbacks were provided when pname:tensor was
    created, pname:pAllocator must: be `NULL`
****

include::{generated}/validity/protos/vkDestroyTensorARM.adoc[]
--


[[resources-tensor-description]]
=== Tensor Description

[open,refpage='VkTensorDescriptionARM',desc='Structure describing a tensor',type='structs']
--
The sname:VkTensorDescriptionARM structure is defined as:

include::{generated}/api/structs/VkTensorDescriptionARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:tiling is a elink:VkTensorTilingARM value specifying the tiling of
    the tensor
  * pname:format is a one component elink:VkFormat describing the format and
    type of the data elements that will be contained in the tensor.
  * pname:dimensionCount is the number of dimensions for the tensor.
  * pname:pDimensions is a pointer to an array of integers of size
    pname:dimensionCount providing the number of data elements in each
    dimension.
  * pname:pStrides is either `NULL` or is an array of size
    pname:dimensionCount providing the strides in bytes for the tensor in
    each dimension.
  * pname:usage is a bitmask of elink:VkTensorUsageFlagBitsARM specifying
    the usage of the tensor.

When describing a tensor created with ename:VK_TENSOR_TILING_OPTIMAL_ARM,
pname:pStrides must be equal to `NULL`.
When describing a tensor created with ename:VK_TENSOR_TILING_LINEAR_ARM,
pname:pStrides is either an array of size pname:dimensionCount or `NULL`.

The formats that must: be supported for pname:format are documented in
<<features-formats-mandatory-features-tensor>>.

[[resources-tensor-description-strides]]
Each element in the pname:pStrides array describes the offset in bytes
between increments of the given dimension.
For example, pname:pStrides[0] describes the offset between element
[x0,x1,x2,x3] and element [x0+1,x1,x2,x3].
The pname:pStrides array can: be used to determine whether a tensor is
_packed_ or not.
If pname:pStrides[pname:dimensionCount-1] is equal to the size of a tensor
element and for each dimension `n` greater than 0 and less than
pname:dimensionCount, pname:pStrides[n-1] is equal to [eq]#pname:pStrides[n] *
pname:pDimensions[n]#, then the tensor is a packed tensor.
If the <<features-tensorNonPacked, tensorNonPacked>> feature is not enabled,
the tensor must: be a packed tensor.

When a tensor is created with ename:VK_TENSOR_TILING_LINEAR_ARM and
pname:pStrides equal to `NULL` the tensor strides are calculated by the
...
****
  * [[VUID-VkTensorDescriptionARM-dimensionCount-09733]]
    pname:dimensionCount must: be less than or equal to
    slink:VkPhysicalDeviceTensorPropertiesARM::pname:maxTensorDimensionCount
  * [[VUID-VkTensorDescriptionARM-pDimensions-09734]]
    For each [eq]#i# where [eq]#i {leq} dimensionCount-1#,
    [eq]#pname:pDimensions[i]# must: be greater than `0`
  * [[VUID-VkTensorDescriptionARM-pDimensions-09883]]
    For each [eq]#i# where [eq]#i {leq} dimensionCount-1#,
    [eq]#pname:pDimensions[i]# must: be less than or equal to
    <<limits-maxPerDimensionTensorElements,
    sname:VkPhysicalDeviceTensorPropertiesARM::pname:maxPerDimensionTensorElements>>
  * [[VUID-VkTensorDescriptionARM-format-09735]]
    pname:format must: not be ename:VK_FORMAT_UNDEFINED and must: be a
    one-component elink:VkFormat
  * [[VUID-VkTensorDescriptionARM-pStrides-09736]]
    [eq]#pname:pStrides[pname:dimensionCount-1]# must: equal the size in
    bytes of a tensor element
  * [[VUID-VkTensorDescriptionARM-pStrides-09737]]
    For each [eq]#i#, [eq]#pname:pStrides[i]# must: be a multiple of the
    element size
  * [[VUID-VkTensorDescriptionARM-pStrides-09738]]
    For each [eq]#i#, [eq]#pname:pStrides[i]# must: be greater than `0` and
    less than or equal to
    slink:VkPhysicalDeviceTensorPropertiesARM::pname:maxTensorStride
  * [[VUID-VkTensorDescriptionARM-pStrides-09884]]
    [eq]#pname:pStrides[0] {times} pname:pDimensions[0]# must: be less than
    or equal to <<limits-maxTensorSize,
    sname:VkPhysicalDeviceTensorPropertiesARM::pname:maxTensorSize>>
  * [[VUID-VkTensorDescriptionARM-pStrides-09739]]
    For each [eq]#i# greater than 0, [eq]#pname:pStrides[i-1]# must: be
    greater than or equal to [eq]#pname:pStrides[i] {times}
    pname:pDimensions[i]# so that no two elements of the tensor reference
    the same memory address
  * [[VUID-VkTensorDescriptionARM-None-09740]]
    If the <<features-tensorNonPacked, tensorNonPacked>> feature is not
    enabled, then the members of slink:VkTensorDescriptionARM must: describe
    a packed tensor
  * [[VUID-VkTensorDescriptionARM-tiling-09741]]
    If pname:tiling is ename:VK_TENSOR_TILING_OPTIMAL_ARM and pname:usage is
    ename:VK_TENSOR_USAGE_IMAGE_ALIASING_BIT_ARM then the size of the tensor
    along its innermost dimension, i.e.
    [eq]#pname:pDimensions[pname:dimensionCount - 1]#, must: be less than or
    equal to `4`
  * [[VUID-VkTensorDescriptionARM-tiling-09742]]
    If pname:tiling is ename:VK_TENSOR_TILING_LINEAR_ARM then
    ename:VK_TENSOR_USAGE_IMAGE_ALIASING_BIT_ARM must: not be set in
    pname:usage
ifdef::VK_ARM_tensor_controls[]
  * [[VUID-VkTensorDescriptionARM-tiling-09842]]
    If pname:tiling is ename:VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM or
    ename:VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM then
    pname:pDimensions[pname:dimensionCount-1] must: be less than or equal to
    `4`
  * [[VUID-VkTensorDescriptionARM-tiling-09843]]
    If pname:tiling is ename:VK_TENSOR_TILING_BRICK_16_WIDE_ARM,
    ename:VK_TENSOR_TILING_BRICK_8_WIDE_ARM,
    ename:VK_TENSOR_TILING_BRICK_4_WIDE_ARM,
    ename:VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM, or
    ename:VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM, then pname:pStrides
    must: be `NULL`
endif::VK_ARM_tensor_controls[]
****

include::{generated}/validity/structs/VkTensorDescriptionARM.adoc[]
--

[open,refpage='VkTensorUsageFlagBitsARM',desc='Bitmask specifying allowed usage of a tensor',type='enums']
--
Bits which can: be set in slink:VkTensorDescriptionARM::pname:usage,
specifying usage behavior of a tensor, are:

include::{generated}/api/enums/VkTensorUsageFlagBitsARM.adoc[]

  * ename:VK_TENSOR_USAGE_SHADER_BIT_ARM specifies that the tensor can: be
    used to create a sname:VkTensorViewARM suitable for occupying a
    sname:VkDescriptorSet slot of type ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM
    accessed by shader stages.
  * ename:VK_TENSOR_USAGE_TRANSFER_SRC_BIT_ARM specifies that the tensor
  ...
  * ename:VK_TENSOR_USAGE_TRANSFER_DST_BIT_ARM specifies that the tensor
    can: be used as the destination of a transfer command.
  * ename:VK_TENSOR_USAGE_IMAGE_ALIASING_BIT_ARM specifies that the tensor
    can: be bound to a range of memory aliased with an image created with
    ename:VK_IMAGE_TILING_OPTIMAL.
    See <<resources-memory-aliasing>> for a complete set of rules for
    tensor/image aliasing.
ifdef::VK_ARM_data_graph[]
  * ename:VK_TENSOR_USAGE_DATA_GRAPH_BIT_ARM specifies that the tensor can:
    be used to create a sname:VkTensorViewARM suitable for occupying a
    sname:VkDescriptorSet slot of type ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM
    accessed by <<graphs-pipelines,data graph pipelines>>.
endif::VK_ARM_data_graph[]
--

[open,refpage='VkTensorUsageFlagsARM',desc='Bitmask of VkTensorUsageFlagBitsARM',type='flags']
--
include::{generated}/api/flags/VkTensorUsageFlagsARM.adoc[]

tname:VkTensorUsageFlags is a bitmask type for setting a mask of zero or
more elink:VkTensorUsageFlagBitsARM.
--

[open,refpage='VkTensorTilingARM',desc='Specifies the tiling arrangement of data in an tensor',type='enums']
--
Possible values of slink:VkTensorCreateInfoARM::pname:tiling, specifying the
tiling arrangement of elements in the tensor, are:

include::{generated}/api/enums/VkTensorTilingARM.adoc[]

  * ename:VK_TENSOR_TILING_OPTIMAL_ARM specifies optimal tiling (elements
    are laid out in an implementation-dependent arrangement, for more
    efficient memory access).
  * ename:VK_TENSOR_TILING_LINEAR_ARM specifies linear tiling (elements are
    laid out linearly and the offset between each element is determined by
    the <<resources-tensor-description-strides,strides>> of the tensor).
ifdef::VK_ARM_tensor_controls[]
  * ename:VK_TENSOR_TILING_BRICK_16_WIDE_ARM specifies that the data is laid
    out in 64-byte blocks of [eq]#16 x N# elements where [eq]#N# depends on
    the size of the elements in the tensor.
  * ename:VK_TENSOR_TILING_BRICK_8_WIDE_ARM specifies that the data is laid
    out in 64-byte blocks of [eq]#8 x N# elements where [eq]#N# depends on
    the size of the elements in the tensor.
  * ename:VK_TENSOR_TILING_BRICK_4_WIDE_ARM specifies that the data is laid
    out in 64-byte blocks of [eq]#4 x N# elements where [eq]#N# depends on
    the size of the elements in the tensor.
  * ename:VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM specifies that the data
    is laid out using blocks of size [eq]#16 x 16 x C# where [eq]#C# is the
    size of the tensor along the innermost dimension.
  * ename:VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM specifies that the
    data is laid out using 64kiB groups of blocks of size [eq]#16 x 16 x C#,
    where [eq]#C# is the size of the tensor along the innermost dimension.
endif::VK_ARM_tensor_controls[]
--


[[resources-tensor-views]]
== Tensor Views

[open,refpage='VkTensorViewARM',desc='Opaque handle to an tensor view object',type='handles']
--
Tensor objects are not directly accessed by pipelines for reading or writing
tensor data.
Instead, _tensor views_ representing the tensor subresources and containing
additional metadata are used for that purpose.
Views must: be created on tensors of compatible types.

Tensor views are represented by sname:VkTensorViewARM handles:

include::{generated}/api/handles/VkTensorViewARM.adoc[]
--

[open,refpage='vkCreateTensorViewARM',desc='Create an tensor view from an existing tensor',type='protos']
--
To create a tensor view, call:

include::{generated}/api/protos/vkCreateTensorViewARM.adoc[]

  * pname:device is the logical device that creates the tensor view.
  * pname:pCreateInfo is a pointer to an instance of the
    sname:VkTensorViewCreateInfoARM structure containing parameters to be
    used to create the tensor view.
  * pname:pAllocator controls host memory allocation as described in the
    <<memory-allocation, Memory Allocation>> chapter.
  * pname:pView is a pointer to a slink:VkTensorViewARM handle in which the
...
The remaining parameters are contained in pname:pCreateInfo.

include::{generated}/validity/protos/vkCreateTensorViewARM.adoc[]
--

[open,refpage='VkTensorViewCreateInfoARM',desc='Structure specifying parameters of a newly created tensor view',type='structs']
--
The sname:VkTensorViewCreateInfoARM structure is defined as:

include::{generated}/api/structs/VkTensorViewCreateInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:flags is reserved for future use.
  * pname:tensor is a slink:VkTensorARM on which the view will be created.
  * pname:format is a elink:VkFormat describing the format and type used to
    interpret elements in the tensor.

If pname:tensor was created with the
ename:VK_TENSOR_CREATE_MUTABLE_FORMAT_BIT_ARM flag, pname:format can: be
...
locations irrespective of the pname:format, with only the interpretation of
...
****
  * [[VUID-VkTensorViewCreateInfoARM-tensor-09743]]
    If pname:tensor was not created with
    ename:VK_TENSOR_CREATE_MUTABLE_FORMAT_BIT_ARM flag, pname:format must:
    be identical to the pname:format used to create pname:tensor
  * [[VUID-VkTensorViewCreateInfoARM-tensor-09744]]
    If pname:tensor was created with
    ename:VK_TENSOR_CREATE_MUTABLE_FORMAT_BIT_ARM flag, pname:format must:
    be compatible with the pname:format used to create pname:tensor, as
    defined in <<formats-compatibility-classes,Format Compatibility
    Classes>>
ifdef::VK_EXT_descriptor_buffer[]
  * [[VUID-VkTensorViewCreateInfoARM-flags-09745]]
    If pname:flags includes
    ename:VK_TENSOR_VIEW_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM,
    the
    <<features-descriptorBufferCaptureReplay,pname:descriptorBufferCaptureReplay>>
    feature must: be enabled
  ...
  * [[VUID-VkTensorViewCreateInfoARM-usage-09747]]
    The pname:usage flags of pname:tensor must: have at least one of the
    following bits set:
  ** ename:VK_TENSOR_USAGE_SHADER_BIT_ARM
ifdef::VK_ARM_data_graph[]
  ** ename:VK_TENSOR_USAGE_DATA_GRAPH_BIT_ARM
  ...
  * [[VUID-VkTensorViewCreateInfoARM-usage-09748]]
    The tensor view's <<resources-tensor-view-format-features,format
    features>> must: contain the format feature flags required by the
    pname:usage flags of pname:tensor for pname:format as indicated in the
    <<format-feature-dependent-usage-flags>> section
  * [[VUID-VkTensorViewCreateInfoARM-tensor-09749]]
    If pname:tensor is non-sparse then it must: be bound completely and
    contiguously to a single slink:VkDeviceMemory object
****

include::{generated}/validity/structs/VkTensorViewCreateInfoARM.adoc[]
--

[open,refpage='VkTensorViewCreateFlagBitsARM',desc='Bitmask specifying additional parameters of an tensor view',type='enums']
--
Bits which can: be set in slink:VkTensorViewCreateInfoARM::pname:flags,
specifying additional parameters of an tensor, are:

include::{generated}/api/enums/VkTensorViewCreateFlagBitsARM.adoc[]
...
[open,refpage='VkTensorViewCreateFlagsARM',desc='Reserved for future use',type='flags']
--
include::{generated}/api/flags/VkTensorViewCreateFlagsARM.adoc[]

tname:VkTensorViewCreateFlagsARM is a bitmask type for setting a mask of
zero or more elink:VkTensorViewCreateFlagBitsARM.
--

[open,refpage='vkDestroyTensorViewARM',desc='Destroy a tensor view object',type='protos']
--
To destroy a tensor view, call:

include::{generated}/api/protos/vkDestroyTensorViewARM.adoc[]

  * pname:device is the logical device that destroys the tensor view.
  * pname:tensorView is the tensor view to destroy.
  * pname:pAllocator controls host memory allocation as described in the
    <<memory-allocation, Memory Allocation>> chapter.
...
****
  * [[VUID-vkDestroyTensorViewARM-tensorView-09750]]
    All submitted commands that refer to pname:tensorView must: have
    completed execution
  * [[VUID-vkDestroyTensorViewARM-tensorView-09751]]
    If sname:VkAllocationCallbacks were provided when pname:tensorView was
    created, a compatible set of callbacks must: be provided here
  * [[VUID-vkDestroyTensorViewARM-tensorView-09752]]
    If no sname:VkAllocationCallbacks were provided when pname:tensorView
    was created, pname:pAllocator must: be `NULL`
****

include::{generated}/validity/protos/vkDestroyTensorViewARM.adoc[]
--


[[resources-tensor-view-format-features]]
=== Tensor View Format Features

Valid usage of a slink:VkTensorViewARM may: be constrained by the tensor
view's format features, defined below.
Such constraints are documented in the affected valid usage statement.

  * If the view's tensor was created with ename:VK_TENSOR_TILING_LINEAR_ARM,
    then the tensor view's set of _format features_ is the value of
    slink:VkTensorFormatPropertiesARM::pname:linearTilingTensorFeatures
    found by calling flink:vkGetPhysicalDeviceFormatProperties2 on the same
    pname:format as slink:VkTensorViewCreateInfoARM::pname:format.
  * If the view's tensor was created with
    ename:VK_TENSOR_TILING_OPTIMAL_ARM, then the tensor view's set of
    _format features_ is the value of
    slink:VkTensorFormatPropertiesARM::pname:optimalTilingTensorFeatures
    found by calling flink:vkGetPhysicalDeviceFormatProperties2 on the same
    pname:format as slink:VkTensorViewCreateInfoARM::pname:format.
ifdef::VK_ARM_tensor_controls[]
  * If the view's tensor was created with
    ename:VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM, then the tensor view's
    set of _format features_ is the value of
    slink:VkTensorExplicitTilingFormatPropertiesARM::pname:blockUTilingTensorFeatures
    found by calling flink:vkGetPhysicalDeviceFormatProperties2 on the same
    pname:format as slink:VkTensorViewCreateInfoARM::pname:format.
  * If the view's tensor was created with
    ename:VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM, then the tensor
    view's set of _format features_ is the value of
    slink:VkTensorExplicitTilingFormatPropertiesARM::pname:blockU64kTilingTensorFeatures
    found by calling flink:vkGetPhysicalDeviceFormatProperties2 on the same
    pname:format as slink:VkTensorViewCreateInfoARM::pname:format.
  * If the view's tensor was created with
    ename:VK_TENSOR_TILING_BRICK_4_WIDE_ARM, then the tensor view's set of
    _format features_ is the value of
    slink:VkTensorExplicitTilingFormatPropertiesARM::pname:brick4TilingTensorFeatures
    found by calling flink:vkGetPhysicalDeviceFormatProperties2 on the same
    pname:format as slink:VkTensorViewCreateInfoARM::pname:format.
  * If the view's tensor was created with
    ename:VK_TENSOR_TILING_BRICK_8_WIDE_ARM, then the tensor view's set of
    _format features_ is the value of
    slink:VkTensorExplicitTilingFormatPropertiesARM::pname:brick8TilingTensorFeatures
    found by calling flink:vkGetPhysicalDeviceFormatProperties2 on the same
    pname:format as slink:VkTensorViewCreateInfoARM::pname:format.
  * If the view's tensor was created with
    ename:VK_TENSOR_TILING_BRICK_16_WIDE_ARM, then the tensor view's set of
    _format features_ is the value of
    slink:VkTensorExplicitTilingFormatPropertiesARM::pname:brick16TilingTensorFeatures
    found by calling flink:vkGetPhysicalDeviceFormatProperties2 on the same
    pname:format as slink:VkTensorViewCreateInfoARM::pname:format.
endif::VK_ARM_tensor_controls[]
